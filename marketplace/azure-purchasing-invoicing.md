...
Po tym, jak znajdziesz właściwą aplikację, ukończenie zakupu jest proste. Będziesz jednak potrzebować odpowiednich uprawnień w ramach subskrypcji platformy Azure. Ponieważ platforma Azure działa na podstawie modelu Access Control (RBAC),  Twoje konto  musi mieć uprawnienia właściciela subskrypcji lub współautora, aby dokonać zakupu. [](/azure/role-based-access-control/overview)
...
W Azure Marketplace aplikacji znajdź Azure Portal, którą chcesz kupić, a następnie  wybierz pozycję Utwórz lub **skonfiguruj + subskrybuj**. Przed rozpoczęciem korzystania z nowego rozwiązania zostanie wyświetlony monit o ukończenie pewnych informacji.
