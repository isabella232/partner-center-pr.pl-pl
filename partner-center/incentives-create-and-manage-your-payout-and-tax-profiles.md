...
**Odpowiednie role:** Administratorzy zachęt | Konto administratora | Administrator globalny
...
Jeśli musisz poprosić o uprawnienia administratora zachęt, skontaktuj się z administratorem MPN lub administratorem globalnym. Aby dowiedzieć się, kto w firmie ma te role, logując się do pulpitu nawigacyjnego usługi [Partner Center,](https://partner.microsoft.com/dashboard/)wybierz  ikonę koła zębatego Ustawienia, pozycję Konto **Ustawienia, a** następnie wybierz pozycję Zarządzanie użytkownikami i odfiltruj pozycję Administrator globalny.
...
> [!IMPORTANT]
> Musisz być administratorem zachęty, aby tworzyć profile płatności i profile podatkowe oraz zarządzać nimi w Partner Center. Role zachęt muszą być przypisane do każdej lokalizacji MPN w ramach każdego programu zachęt. Aby uzyskać więcej informacji na temat dodawania administratorów zachęt w Partner Center, zobacz [Tworzenie kont użytkowników.](create-user-accounts-and-set-permissions.md)

## <a name="access-the-payout-and-tax-section-in-partner-center"></a>Uzyskaj dostęp do sekcji wypłaty i podatku w Partner Center

1. Zaloguj się do pulpitu [Partner Center nawigacyjnego](https://partner.microsoft.com/dashboard/) przy użyciu konta usługi Azure Active Directory (Azure AD) (konta firmowego) lub odpowiedniego adresu e-mail, jeśli został przypisany.
...
2. Wybierz **pozycję Wypłaty i podatek,** a następnie **wybierz pozycję Wypłaty i profile podatkowe.**
...
1. Na stronie **Szczegóły** wypełnij następujące pola: **Nazwa profilu:** Wprowadź unikatową nazwę identyfikującą ten profil płatności.
    ...
    **Formy płatności:** Preferowaną metodą płatności za Partner Center jest przelew bankowy.
...
W przypadku firm partnerskich w Stanach Zjednoczonych, jeśli potrzebujesz informacji dotyczących wypełniania formularzy W8 lub W9, następujące adresy prowadzą do strony urzędu skarbowego (IRS):
...
6. W sekcji formularza podatkowego zaktualizuj formularze podatkowe, podając nowe szczegóły.
