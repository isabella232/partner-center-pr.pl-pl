...
1. Zaloguj się na Partner Center [nawigacyjnym](https://partner.microsoft.com/dashboard/) przy użyciu konta Azure Active Directory (azure AD) (konta firmowego) lub odpowiedniego adresu e-mail, jeśli został przypisany.
