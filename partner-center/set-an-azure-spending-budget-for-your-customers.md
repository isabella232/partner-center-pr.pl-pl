...
2. Wybierz **kafelek Rozliczenia,** a następnie wybierz pozycję **Wydatki na platformę Azure.**
...
Budżet *dla pojedynczego klienta można ustawić w* ustawieniach subskrypcji.
...
Możesz ustawić *miesięczny budżet wydatków na platformę Azure* dla wielu klientów:
...
**Usuwanie budżetu wydatków na platformę Azure**
...
2. Wybierz ikonę Ustawienia koła zębatego, a następnie wybierz **pozycję Moje preferencje.**

3. Skonfiguruj preferowany adres e-mail, jeśli nie został jeszcze skonfigurowany.

4. Skonfiguruj preferowany język powiadomienia.

5. Wybierz **kartę CSP** w **sekcji Preferencje** powiadomień.

6. Zaznacz opcję E-mail dla **powiadomienia wydatków na platformę Azure** i **zapisz**.
