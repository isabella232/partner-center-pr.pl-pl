...
- Sumy dorzucane przez klientów netto są sumowane w ciągu ostatnich 12 miesięcy. 

- Możliwe jest dodanie łącznie 10 klientów netto, a maksymalna możliwa wartość zarobków wynosi 10 punktów (jeden punkt za każdy punkt dodawania przez klienta netto).
...
Aby uzyskać maksymalnie **30 punktów konsultanta** funkcjonalnego w celu uzyskania tej kompetencji, partnerzy muszą mieć **5** konsultantów, którzy mają:
