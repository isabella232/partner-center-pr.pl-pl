...
W tym artykule opisano siedem kluczowych wskaźników udziału partnera (PCI, Partner Contribution Indicators) używanych do oceny postępów partnera w osiągnięciu lub zachowaniu kompetencji Silver lub Gold Cloud Business Applications kompetencji.
...
- [Sposób poszczególnych wskaźników PCI](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)
...
Wskaźniki udziału partnerów zapewniają całościową miarę wpływu partnera na osiąganie pomyślnych wyników klientów, a tym samym większe różnice na rynku, gdy partner osiągnie lub zachowuje kompetencję w zakresie platformy Silver lub Gold Cloud Business Applications.
...
Gdy partner osiąga pewne poziomy wpływu na przykład w kluczowych wskaźnikach, partner może uzyskać (lub zachować) kompetencję Silver lub Gold Cloud Business Applications kompetencję.
...
Każdy wskaźnik zapewnia ocenę, która jest dodawana do sumy. Poniżej znajdują się maksymalne wyniki dla każdego wskaźnika kompetencji cloud Business Applications:
...
Na przykład opracowany partner na rynku o wartości 150 000 USD w nowym przychodzie netto będzie zdobywać połowę (150 000 USD/300 000 USD) z maksymalnie 10 punktów.
...
- Jesteś klientem Dostawca rozwiązań w chmurze (CSP) dla płatnej subskrypcji należącej do dzierżawy tego klienta
...
- Nowy przychód netto jest obliczany na podstawie następujących kwalifikujących się produktów:
  - Produkty kwalifikujące się do zaangażowania klientów obejmują: Sprzedaż, Obsługa klienta, Field Service, Project Service Automation, Marketing, Microsoft Relationship Sales, Plan 1, Talent i Enterprise Team Member.
...
### <a name="definitions-for-pci-metric-2---net-customer-adds"></a>Definicje metryk PCI dla #2 — klienci sieci
...
- Punkty dodane przez klientów sieciowych są obliczane co miesiąc, ponieważ klienci dodani minus klienci utraceni i są agregowane w ciągu 12 miesięcy. 
...
- Punkty maksymalne i częściowe można zdobywać za dodanie klientów netto. Poniżej przedstawiono wymagania dotyczące zdobywania maksymalnej liczby punktów dla danej kompetencji:
  ...
  |---------------------|----------------------------|
  | Customer Engagement | — 10 klientów netto (dla partnerów na rynkach *rozwiniętych);*</br>— 5 nowych klientów netto (dla partnerów na *rynkach rozwijających* się)  |
...
- W przypadku wielu partnerów/tego samego klienta lub klienta  współpracującego  bezpośrednio z firmą Microsoft: Istnieją różne obliczenia dotyczące dorzucania klientów i utraconych klientów w przypadku, gdy wielu partnerów jest skojarzonych z tym samym klientem za pośrednictwem różnych subskrypcji lub w przypadkach, gdy klient może już pracować bezpośrednio z firmą Microsoft. Te obliczenia są wyświetlane poniżej.
...
- Rozwój konsultanta funkcjonalnego jest definiowany jako wzrost liczby certyfikowanych partnerów konsultanci funkcjonalni od migawki linii bazowej. Data migawki linii bazowej zostanie podjęta 1 października 2020 r.
...
- Migawka linii bazowej zostanie zresetowana przy następnej dacie odnowienia Business Applications chmury.
...
- Opracowani partnerzy biznesowi mogą uzyskać certyfikację co najmniej 50 konsultantów funkcjonalnych w ramach pierwszej rocznicy kompetencji Cloud Business Applications PCI. (Opracowywanie partnerów handlowych może certyfikować 25 lub więcej konsultantów funkcjonalnych w czasie na pierwszą rocznicę kompetencji cloud Business Applications PCI).

- Jeśli osiągniesz ten próg, otrzymasz pełne 15 punktów za konsultanci funkcjonalni wzrost przez 24 miesiące od tej daty. Oznacza to, że otrzymasz maksymalne punkty za konsultanci funkcjonalni wzrost w przypadku dwóch rocznic Business Applications chmury.
...
- Punkty wskaźnika Deweloperzy są oparte na migawce z bieżącego miesiąca z maksymalnie 5 dostępnymi punktami.
...
- Wszyscy partnerzy powiązani z dowolną płatną subskrypcją w ramach dzierżawy otrzymają kredyt dla wszystkich wystąpień produkcyjnych Customer Engagement lub Finance and Operations w ramach tej dzierżawy.
...
- Miesięczny wzrost liczby aktywnych użytkowników jest definiowany inaczej w przypadku ścieżek Customer  Engagement i Finance and Operations, a dla partnerów działających na rynkach rozwiniętych i na *rynkach rozwijających* się:
...
- Wszyscy partnerzy powiązani z dowolną płatną subskrypcją w ramach dzierżawy otrzymają środków dla wszystkich aktywnych użytkowników miesięcznie Customer Engagement lub Finance and Operations zsumowanych we wszystkich płatnych subskrypcjach w ramach tej dzierżawy.
