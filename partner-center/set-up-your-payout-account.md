...
> [!NOTE]
> Na niektórych rynkach można PayPal na koncie wypłaty. Aby dowiedzieć się, PayPal są obsługiwane na określonym rynku, zobacz [Progi,](payment-thresholds-methods-timeframes.md) metody i harmonogramy płatności oraz informacje o PayPal [poniżej,](#paypal-info) aby uzyskać więcej szczegółowych informacji.
...
- **Czy muszę ręcznie akceptować PayPal płatności?** Nie. PayPal konta są domyślnie ustawione tak, aby wymagać od użytkowników ręcznego akceptowania płatności, co oznacza, że jeśli nie zaakceptujesz płatności w ciągu 30 dni, zostanie ona zwrócona. To ustawienie można zmienić, wyłączając ustawienie "Zadaj mi pytanie" na PayPal więcej Ustawienia aplikacji.

- **Jakie waluty są PayPal obsługuje?** Zobacz [PayPal pomocy technicznej bieżącej](https://developer.paypal.com/docs/classic/api/currency-codes/#paypal) listy
...
Form-R to wymaganie prawne dotyczące bankowości internetowej. Służy do wskazywania przeznaczenia i przyczyny otrzymania środków od osób chętnych. W związku z tym za każdym razem, gdy kwalifikujesz się do comiesięcznej wypłaty od firmy Microsoft, musisz przesłać formularz Form-R do banku, zanim wypłata zostanie wydana na Twoje konto. Skontaktuj się z lokalną gałęzią banku, aby uzyskać instrukcje dotyczące uzyskiwania kopii formularza Form-R.

W każdym miesiącu musisz przesłać formularz Form-R do banku, który kwalifikuje się do wypłaty. Jeśli na przykład oczekujesz wypłaty w każdym miesiącu roku, musisz przesłać formularz Form-R 12 razy (raz w miesiącu).
...
Jeśli jesteś wydawcą, który mieszka w Rosyjskim, może być konieczne dostarczenie dokumentacji bankowi, zanim bank zdeponuje środki na Twoim koncie. Jeśli kwalifikujesz się do otrzymania zapłaty, w wiadomości e-mail udostępnimy następującą dokumentację:

- Certyfikat akceptacji (AC) — zawiera kwotę wypłaty przeniesioną na Konto.
- [Microsoft Azure Marketplace Publisher Agreement](/legal/marketplace/msft-publisher-agreement) — podpisana kopia umowy wydawcy, która musi być podpisana jako licznik.

Aby upewnić się, że wypłata powiodła się, upewnij się, że:

- Nazwa **właściciela konta wprowadzona** dla Twojego konta Partner Center musi być dokładnie taka sama jak nazwa skojarzona z Twoim kontem bankowym. Jeśli na przykład nazwa konta bankowego zawiera drugie imię i nazwisko, dodaj drugie imię do nazwy **właściciela konta**.
...
Jeśli wybrano korzystanie z konta bankowego w celu otrzymywania wypłat, należy wykonać następujący proces konfigurowania konta bankowego.

1. Na *stronie PayPal* podaj wymagane informacje o PayPal konta.
