---
title: Konfigurowanie profilów wypłat i profilów podatkowych na platformie handlowej
...
ms.locfileid: "129663397"
---
# <a name="set-up-commercial-marketplace-payout-and-tax-profiles"></a>Konfigurowanie profilów wypłat i profilów podatkowych na platformie handlowej
...
> [!IMPORTANT]
> Różne kraje i regiony mają różne wymagania podatkowe. Dokładna kwota, którą należy zapłacić w podatkach, zależy od krajów i regionów, w których sprzedajesz ofertę. Zobacz umowę [Microsoft Azure Marketplace Publisher,](/legal/marketplace/msft-publisher-agreement) aby dowiedzieć się, dla których krajów/regionów firma Microsoft remituje sprzedaż i korzysta z podatku w Twoim imieniu. W innych krajach/regionach, w zależności od tego, gdzie jest zarejestrowana, może być konieczne pominięcie sprzedaży i użycie podatku dla sprzedaży z oferty bezpośrednio do lokalnego urzędu skarbowego. Ponadto przychody ze sprzedaży aplikacji mogą być rozliczane jako dochód. Zdecydowanie zachęcamy do skontaktowania się z odpowiednim urzędem w danym kraju lub regionie, co może pomóc w ustaleniu odpowiednich informacji podatkowych dla działań na platformie handlowej.

1. Zaloguj się do pulpitu [Partner Center,](https://partner.microsoft.com/dashboard)wybierz ikonę koła Ustawienia, a następnie wybierz **pozycję Ustawienia konta.**

2. Wybierz **pozycję Wypłata i podatek,** a następnie wybierz **pozycję Wypłaty i przypisania podatkowe.**
...
> [!NOTE]
> Na niektórych rynkach można PayPal na koncie wypłaty. Aby dowiedzieć się, PayPal są obsługiwane na określonym rynku, zobacz [Progi,](payment-thresholds-methods-timeframes.md) metody i harmonogramy płatności oraz informacje o PayPal [poniżej,](#paypal-information) aby uzyskać więcej informacji.
...
- Informacje o banku wprowadzone Partner Center alfabetu łacińskiego są tłumaczone na znaki cyrylicy.
...
### <a name="paypal-information"></a>PayPal informacji

W wybranych krajach i regionach możesz utworzyć konto płatności, wprowadzając PayPal danych. Jednak przed wybraniem PayPal jako opcji konta płatności:
...
- **Jakie waluty obsługuje PayPal walut?** Zobacz [PayPal pomocy technicznej bieżącej](https://developer.paypal.com/docs/classic/api/currency-codes/#paypal) listy
...
Jeśli jesteś wydawcą, który mieszka w Rosyjskim, może być konieczne dostarczenie do banku dokumentacji, zanim bank zdeponuje środki na Twoim koncie. Jeśli kwalifikujesz się do otrzymania opłaty, w wiadomości e-mail udostępnimy następującą dokumentację:
...
Jeśli jesteś wydawcą, który mieszka w Amie, może być konieczne dostarczenie dokumentacji do banku, zanim bank zdeponuje środki na Twoim koncie. Jeśli kwalifikujesz się do otrzymania opłaty, w wiadomości e-mail udostępnimy następującą dokumentację:
...
5. Należy wybrać profil płatności dla każdego programu, w ramach których uczestniczysz, chociaż możesz użyć tego samego profilu dla wielu programów.
