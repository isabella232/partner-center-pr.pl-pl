...
|-----|    -----    |    -----    |    -----    |
|Nazwa |    Yes     |    Przyjazna nazwa zapytania     |    ciąg     |
|    Opis     |    Nie     |    Opis danych zwracanych przez zapytanie     |    ciąg     |
|    Zapytanie     |    Yes     |    Ciąg zapytania raportu     |    Typ danych: ciąg <br> [Zapytanie niestandardowe oparte](insights-programmatic-custom-query.md) na potrzebach biznesowych |
|        |        |        |        |
...
Po zakończeniu wykonywania raportu zostanie pokazany `Completed` stan wykonywania. Raport można pobrać, wybierając adres URL w polu `reportAccessSecureLink` .
...
|    Parametr    |    Opis    |
|    ----    |    ----    |
|    Executionid    |    Unikatowy identyfikator wystąpienia wykonywania (UUID)    |
