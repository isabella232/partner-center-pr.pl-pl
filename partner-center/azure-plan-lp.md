...
|Przechodzenie klientów z płatności za korzystanie z płatności za pomocą konta na plan platformy Azure|[Przenoszenie klienta do planu platformy Azure](azure-plan-transition.md)|
