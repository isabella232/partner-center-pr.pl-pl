...
| earningExchangeRate | Exchange używana do pokazywania odpowiedniej kwoty w USD | Wszystko |
...
| Opłaty | Przedstawia podział wszystkich szczegółów opłat zagregowanych w kolumnie Kwota transakcji (uwzględnionych tylko dla Azure Marketplace; nieujętego w **zarezerwowanym** pliku CSV). |
|||
