...
description: Wprowadzono wymagania dotyczące zabezpieczeń partnerów w celu włączenia uwierzytelniania wieloskładnikowego (MFA) i przyjęcia model aplikacji zabezpieczonych usługi.
author: vijvala
ms.author: vijvala
...
- W przypadku partnerów, którzy [korzystają z](/azure/active-directory/conditional-access/concept-conditional-access-policy-common)dostępu warunkowego, wartości domyślne zabezpieczeń nie [będą dostępne.](/azure/active-directory/fundamentals/concept-fundamentals-security-defaults#disabling-security-defaults)
...
- [Partner Center przykładów w](https://github.com/microsoft/partner-center-java-samples)języku Java: to GitHub repozytorium zawiera przykłady opracowane przy użyciu języka Java, które pokazują, jak można zaimplementować model aplikacji zabezpieczonych platformę.
