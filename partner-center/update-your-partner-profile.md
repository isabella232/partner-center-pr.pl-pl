...
>[!Important]
>Jeśli jesteś partnerem Dostawca rozwiązań w chmurze (CSP), nie możesz zmienić kraju skojarzonego z Twoim adresem prawnym. Twój kraj adresu prawnego jest powiązany z Twoją dzierżawą i usługami, a także walutą, z która jest robisz. Aby dowiedzieć się więcej o aktualizacjach kraju MPN, przeczytaj [Aktualizacje kraju MPN.](manage-locations.md#change-country-of-partner-global-account)


### <a name="who-can-update-legal-business-name-and-when"></a>Kto i kiedy może aktualizować legalną nazwę firmy

|**Program**|**Kto może aktualizować nazwę firmy**|**Kiedy można je zaktualizować (stan)**|**Dozwolone**|
|---------------------|:-------------------------------|:------------|:-----------------|
