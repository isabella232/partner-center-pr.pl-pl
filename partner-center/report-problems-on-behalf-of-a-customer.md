...
1. Z menu Centrum partnerskiego w obszarze CSP wybierz pozycję **Klienci**

2. Na stronie Klienci wybierz lub wyszukaj wybranego klienta
    
3. Z menu klienta wybierz pozycję **Żądania obsługi**

4. Z menu **rozwijanego Nowe** żądanie wybierz pozycję **Azure** **lub Office 365, Dynamics 365, Enterprise Mobility Suite.** Nastąpi przekierowanie do portalu Microsoft Azure lub do Office 365 administracyjnego.

>[!NOTE]
>Partnerzy ds. operacji pomocy technicznej, którzy transkują usługę Dynamics 365 w programie CSP, są zobowiązani do utrzymania umowy pomocy technicznej dotyczącej planu Pomocy technicznej zaawansowanej dla partnerów (ASfP) lub wyższego. Ta umowa pomocy technicznej jest wymagana do przesyłania zdarzeń usługi Dynamics 365 w imieniu klienta CSP. [Dowiedz się więcej](https://partner.microsoft.com/support/partnersupport) o opcjach umowy pomocy technicznej.
...
>
>- Aby jako odsprzedawca pośredni tworzył żądania obsługi dla klienta na platformie Azure, twój dostawca pośredni musi udzielić Ci dostępu do konta platformy Azure klienta. Różni się to od administrowania w imieniu klientów dla Office 365.
>
>- Mimo że administrator pomocy technicznej w usłudze Partner Center nie może tworzyć żądań obsługi w portalu usługi Azure, można utworzyć grupę pomocy technicznej w portalu usługi Platformy Azure i nadać tej grupie uprawnienia do rejestrować żądania pomocy technicznej.
...
2. Wypełnij wniosek o pomoc techniczną odpowiednimi informacjami, a następnie wybierz pozycję **Utwórz:**
   ...
   - W sekcji **Podstawowe** w żądaniu pomocy technicznej wybierz pozycję Dostawca rozwiązań w chmurze **w** **polu Plan** pomocy technicznej.

   - W **sekcji Informacje** kontaktowe w żądaniu pomocy technicznej wprowadź swoje informacje, a nie informacje o kliencie.

3. Później przejrzyj żądania obsługi klienta w portalu usługi Microsoft Azure, wybierając pozycję **Zarządzaj żądaniami pomocy technicznej.**
...
W jednym z tych przypadków możesz użyć poniższej procedury, aby utworzyć wniosek o pomoc techniczną. 

1. Skopiuj nazwę domeny klienta ze strony konta w Partner Center.
...
2. Wypełnij formularz żądania obsługi, a następnie wybierz pozycję **Prześlij**.
   ...
   > [!TIP]
   > Pamiętaj, aby dołączyć informacje kontaktowe, a nie dane klienta.
...
2.  Na stronie produktu znajdziesz informacje kontaktowe pomocy technicznej. Może to być co najmniej jedna z następujących opcji:
...
Nasze początkowe czasy odpowiedzi zależą od ważności przesłanego zdarzenia. Ważność problemu jest określana przez wskazanie wpływu na działalność firmy podczas przesyłania żądania obsługi.
...
- Umiarkowany wpływ (ważność B): cztery godziny (umiarkowana utrata lub obniżenie jakości usług. Częściowo dotyczy to usług produkcyjnych).
- Minimalny wpływ (ważność C): osiem godzin (minimalna utrata lub pogorszenie jakości usług. Usługi nadal dostępne lub nieprodukcyjne, których dotyczy problem).

Początkowe czasy odpowiedzi są dostępne tylko w przypadku obsługi w języku angielskim. Obsługa języków lokalnych jest zapewniana w godzinach pracy.
W przypadku zdarzeń, które nie są uznawane za zdarzenia łamania uprawnień do pomocy technicznej, początkowy czas odpowiedzi może być nawet jeden dzień biznesowy.

### <a name="can-i-submit-a-service-request-by-phone"></a>Czy mogę przesłać żądanie obsługi przez telefon?

Nie, pomoc techniczna przez telefon nie jest oferowana dla tego programu.
...
Jeśli logujesz się Microsoft Azure portalu, centrum jest wyświetlane we własnym kontekście, a nie w kontekście klienta. Dlatego podczas tworzenia żądania obsługi dla własnych subskrypcji należy logować się bezpośrednio do Microsoft Azure portal.

Uprawnienie do pomocy technicznej programu CSP nie zapewnia pomocy technicznej dla Twojej subskrypcji partnera. W związku z tym musisz podać prawidłowe uprawnienie do planu pomocy technicznej podczas tworzenia żądania obsługi, które dotyczy Twojej subskrypcji partnera. Przykłady obejmują identyfikator kontraktu MPN, premier lub plan pomocy technicznej platformy Azure. Aby uzyskać więcej informacji, zobacz [często zadawane pytania dotyczące pomoc techniczna platformy Azure usługi](https://go.microsoft.com/fwlink/?LinkId=717532).
...
Jeśli logujesz się Office 365 centrum administracyjnego, wyświetlasz centrum w swoim kontekście, a nie w kontekście klienta. Dlatego podczas tworzenia żądania obsługi dla własnych subskrypcji należy logować się bezpośrednio Office 365 centrum administracyjnego usługi.
