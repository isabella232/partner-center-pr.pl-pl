...
description: Wzmacniaj swój profil biznesowy w katalogu partnerów firmy Microsoft. Dowiedz się, jak używać Partner Center, aby aplikować i zdobywać specjalizacje zaawansowane.
...
ms.locfileid: "123958462"
---
# <a name="use-partner-center-to-apply-for-advanced-specializations-and-check-their-status"></a>Użyj Partner Center, aby zastosować do zaawansowanych specjalizacji i sprawdzić ich stan

**Odpowiednie role:** Administrator globalny | Administrator konta

W tym artykule opisano, jak używać pulpitu [](advanced-specializations.md)nawigacyjnego Partner Center, aby zastosować zaawansowaną specjalizację, sprawdzić postęp oraz wykonać niezbędne kroki i weryfikacje. Zobaczysz również przykłady użycia narzędzi Partner Center do uzyskania niektórych zaawansowanych specjalizacji, które wymagają inspekcji lub odwołań klientów.

Aby dowiedzieć się więcej o zaletach zaawansowanych specjalizacji i ich specyficznych wymaganiach, zobacz [Microsoft Partner Network zaawansowanych specjalizacji.](https://partner.microsoft.com/membership/advanced-specialization)
...
4. Po zakończeniu wszystkich wymagań dotyczących zaawansowanej specjalizacji sprawdź ponownie ten obszar Partner Center, aby  sprawdzić, czy Twój stan zmienił się na Aktywny dla konkretnej specjalizacji zaawansowanej.
...
| Obliczeniowy system operacyjny | Obliczeniowy system operacyjny |
| Compute Core Software | Compute Core Software |

**Filtry przychodu z użycia platformy Azure dla zaawansowanej specjalizacji**
...
- Migracja bazy Open-Source z systemem Linux i Microsoft Azure
