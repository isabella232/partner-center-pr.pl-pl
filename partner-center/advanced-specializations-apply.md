...
description: Wzmacniaj swój profil biznesowy w katalogu partnerów firmy Microsoft. Dowiedz się, jak używać Partner Center do aplikowania i zdobywania zaawansowanych specjalizacji.
...
W tym artykule opisano, jak używać pulpitu [](advanced-specializations.md)nawigacyjnego Partner Center, aby zastosować zaawansowaną specjalizację, sprawdzić postęp oraz wykonać niezbędne kroki i weryfikacje. Zobaczysz również przykłady użycia usługi Partner Center do uzyskania niektórych zaawansowanych specjalizacji, które wymagają inspekcji lub odwołań klientów.

Aby dowiedzieć się więcej o korzyściach z zaawansowanych specjalizacji i ich specyficznych wymaganiach, zobacz [Microsoft Partner Network zaawansowanych specjalizacji.](https://partner.microsoft.com/membership/advanced-specialization)
...
Aby zakwalifikować się do zaawansowanej specjalizacji, najpierw musisz spełnić pewne wymagania wstępne, takie jak kompetencja [Gold](https://partner.microsoft.com/membership/competencies) w powiązanym obszarze. Następnie należy zastosować w tej Partner Center i wykonać kluczowe kroki, wymagania i weryfikacje firmy Microsoft dla tej zaawansowanej specjalizacji.

Większość procesu jest dostępna z poziomu pulpitu Partner Center nawigacyjnego. Jednak tylko użytkownicy z określoną Partner Center [dostęp](permissions-overview.md) do tego Partner Center danych.
...
3. Wybierz nazwę zaawansowanej specjalizacji, która wymaga zaplanowania inspekcji. Załóżmy na przykład, że wybierasz opcję Modernizacja aplikacji **internetowych,** aby Microsoft Azure . Zostanie wyświetlona strona wymagań wstępnych dla tej zaawansowanej specjalizacji.
   ...
   :::image type="content" source="images/advanced-specializations/as-1.png" alt-text="Przykładowa strona wymagań wstępnych przedstawiająca wymagania dotyczące zdobycia określonej zaawansowanej specjalizacji.":::
...
3. Wybierz nazwę zaawansowanej specjalizacji, która wymaga podania informacji o klientach. Załóżmy na przykład, że wybierasz spotkania i sale konferencyjne dla **Microsoft Teams**.
   ...
   :::image type="content" source="images/advanced-specializations/as-2.png" alt-text="Przykładowa strona wymagań wstępnych zaawansowanych specjalizacji, która wymaga od klientów odwołania.":::

4. Dopóki nie spełnisz wszystkich wymagań wstępnych pokazanych na tej stronie i nie udostępnisz informacji o klientach, Twój stan pozostanie **Bez uruchomień.** Po spełniania wszystkich wymagań wstępnych stan zmieni się na **Aktywny.**
...
- Dołączone skojarzenia między partnerami i [klientami:](https://support.microsoft.com/topic/link-a-partner-id-for-azure-performance-pal-or-dpor-a8eed43b-82a8-f017-3b1a-f9c8aa385d32) Skojarzenie cyfrowego partnera rekordów z klientem [](/azure/cost-management-billing/manage/link-partner-id) lub partner z rozliczeniami bezpośrednimi w programie CSP lub odsprzedawca pośredni dla klienta lub skojarzenia linku administratora partnera z klientem.
...
- Modernizacja aplikacji internetowych do platformy Microsoft Azure
    - Azure App Service ACR: Poziom usługi 1 = obliczenia i poziom usługi 2 = Azure App Service
    - Azure Spring Cloud ACR:
        - ACR Adjustment Type = N/A
        - Grupa usług 2 = Deweloper aplikacji
        - Grupa usług 3 = Spring Cloud 
        - Poziom usługi 2 = Wszystkie z wyjątkiem "Nieznany"

- Analiza na Microsoft Azure
    - Azure Synapse Analytics ACR: Service Group 3 = SQL DW
    - Data Lake ACR: Service Group 3 = Azure Data Lake
    - Databricks ACR: grupa usług3 = usługa Databricks, maszyna wirtualna usługi Databricks
