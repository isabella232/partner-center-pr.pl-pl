...
ms.locfileid: "121914791"
---
# <a name="february-2020-announcements"></a>Ogłoszenia z lutego 2020 r.

Ta strona zawiera szczegółowe informacje o ogłoszeniach dla firmy Microsoft Partner Center CSP na luty 2020 r.
...
Nasz system wskazuje, że Twoja organizacja aktualnie korzysta z zasad bazowych, ale nie została jeszcze przełączona do domyślnych ustawień zabezpieczeń. Jeśli do 29 lutego nie zostaną przejdą domyślne ustawienia zabezpieczeń, utracisz uwierzytelnianie wieloskładnikowe włączone przy użyciu zasad bazowych w **dzierżawach partnerskich. Włącz ustawienia domyślne zabezpieczeń tak szybko, jak to możliwe, aby uniknąć zakłóceń w działalności biznesowej.**
...
Jeśli masz pytania dotyczące wymagań dotyczących zabezpieczeń partnera, zapoznaj się z dodatkowymi zasobami [tutaj.](https://aka.ms/security-requirements)
...
Nie należy kupować oferty, jeśli jednostka prawna klienta znajduje się w Indiach. Skontaktuj się z lokalnym zespołem konto Microsoft, aby dowiedzieć się, jak najlepiej kontynuować.
...
## <a name="changes-to-partner-center-support-experience"></a><a id="3"/></a>Zmiany w Partner Center obsługi technicznej
...
- [Aktualizacje licencjonowania usługi PowerApps Flow FY20](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
