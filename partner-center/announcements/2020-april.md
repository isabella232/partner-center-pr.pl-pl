...
## <a name="updated-promotions-for-office-365"></a><a id="14"/></a>Zaktualizowane promocje dla usługi Office 365
...
Wszyscy partnerzy inicjujące transakcje za pośrednictwem programu Dostawca rozwiązań w chmurze (CSP). Ta promocja jest dostępna tylko dla nowych klientów komercyjnych.
...
4 maja 2020 r. firma Microsoft wprowadzi nowe promocje rabatu dla usług Office 365 E1 i Microsoft 365 Business Basic, aby zaoferować te produkty bez kosztów przez pierwsze sześć miesięcy rocznej subskrypcji rozliczanych miesięcznie dla nowych klientów.

Te promocje zastąpią bieżącą ofertę wersji próbnej usługi Office 365 E1 i różnią się w następujący sposób:

- Partnerzy będą transakcyjni roczne jednostki SKU usługi Office 365 E1 lub Microsoft 365 Business Basic przy użyciu promocji programu CSP, która stosuje 100% rabatu za pierwsze sześć miesięcy, a nie unikatową jednostkę SKU z sześciomiesięcznych okresów próbnych. [Dowiedz się więcej na temat promocji CSP.](../promotions.md)
- Zamawianie będzie technicznie ograniczone do "tylko nowych klientów", a nie wersji próbnej usługi Office 365 E1, która była ograniczona tylko do nowych klientów za pośrednictwem zasad pisanych. 
- W przypadku klientów korzystających z Microsoft 365 SMB w tej promocji zostanie uwzględniona podstawowa business basic. Dzięki temu partnerzy mogą zacząć od klientów z mniej niż 300 miejscami w odpowiedniej rodzinie produktów z Microsoft 365 dla firm.
Klienci, którzy mają obecnie licencję na wersję próbną usługi Office 365 E1 (dostępną do 4 maja 2020 r.), pozostaną w bieżącym planie — ta zmiana dotyczy tylko nowych klientów netto.
...
- Odwiedź centrum [zasobów pracy zdalnej partnera,](https://www.microsoft.com/microsoft-365/partners/remotework) aby dowiedzieć się więcej o bezpiecznej pracy zdalnej.
...
Aby uzyskać dalsze pytania dotyczące tych ofert, sprawdź odpowiednie społeczności usługi Yammer i skontaktuj się z przedstawicielem w konto Microsoft zespołu.

_________________

## <a name="azure-reservations-new-customer-self-serve-capability-with-partner-permission"></a><a id="13"/></a>Usługa Azure Reservations New Customer Self-Serve możliwość z uprawnieniami partnera
...
Partnerzy w programie Dostawca rozwiązań w chmurze programie
...
Rezerwacje platformy Azure to doskonały sposób na zakup usług platformy Azure po obniżonej cenie. Dzięki tej nowej możliwości partnerzy mogą udzielić klientom uprawnień do zakupu własnych zasobów z elastycznością w ramach istniejących subskrypcji platformy Azure, które już kupili dla swoich klientów.

Poniżej znajdują się szczegółowe informacje na temat sposobu działania tej funkcji:

- Partnerzy mogą włączyć tę możliwość na poziomie indywidualnego konta klienta i zapewnić klientowi kontrolę zakupu.
- Domyślnie funkcja jest ustawiona na wartość "wył.", a partner wybiera włączanie i przyznawanie uprawnień klienta.
...
1. Zacznij pomagać klientom w kupowaniu własnych rezerwacji platformy Azure przy użyciu nowej funkcji.
2. [Przejrzyj zasoby dostępne w tej](https://partner.microsoft.com/resources/collection/customer-permission-to-purchase#/) kolekcji, które zawierają więcej informacji — w tym dokumentację techniczną, przewodnik po doświadczeniach partnera i przewodnik obsługi klienta. [](../give-customers-permission.md)

_________________

## <a name="microsoft-reversed-the-csp-eur-price-for-microsoft-365-e3"></a><a id="12"/></a>Firma Microsoft wycofała cenę CSP EUR dla Microsoft 365 E3.
...
Wszyscy partnerzy inicjujące transakcję M365 E3 za pośrednictwem cennika EUR w Dostawca rozwiązań w chmurze programie.
...
Mimo że ceny są błędne, wprowadzenie korekty i rosnących cen w tej chwili nie jest odpowiednie ze względu na wyjątkowe okoliczności. W związku z tym tymczasowo wracamy do poprzedniej, niższej ceny netto, która obowiązuje od 22 kwietnia 2020 r. Wszystkie faktury natychmiast odzwierciedlają poprzednie niższe ceny, natomiast w cenniku będą wyświetlane niższe ceny z cennika z maja 2020 r., w najbliższej przyszłości.
...
Doceniamy całą wielką pracę, która nasza społeczność partnerska robi w tym niezrównanym czasie.
...
Jeśli potrzebujesz pomocy technicznej dotyczącej operacji wykonywanych przez firmę Microsoft, skontaktuj się z pomocą techniczną, aby uzyskać pytania, pytania lub więcej informacji.
...
Większe i stałe zabezpieczenia i ochrona prywatności należą do naszych głównych priorytetów i nadal pomagamy partnerom chronić swoich klientów i dzierżawców. W 2019 r. wprowadziliśmy obowiązkowe [wymagania dotyczące zabezpieczeń](https://blogs.partner.microsoft.com/mpn/safeguard-business-security-best-practices/). Wszyscy partnerzy biorący udział w programie Dostawca rozwiązań w chmurze, dostawcy Panel sterowania i doradcy powinni zaimplementować wymagania w celu zachowania zgodności.

Niedawno pomyślnie ukończyliśmy aktywowanie zabezpieczeń dla możliwości AOBO (admin-on-behalf-of) dla wszystkich dzierżaw partnerów, chroniąc ich firmy i klientów przed zdarzeniami związanymi z kradzieżą tożsamości.

Aby jeszcze bardziej chronić partnerów i klientów, od 1 maja **2020** r. rozpoczniemy aktywację zabezpieczeń dla transakcji Partner Center CSP. Aktywacja dodatkowych zabezpieczeń oznacza, że partnerzy będą proszeni o użycie uwierzytelniania wieloskładnikowego (MFA) dla wszelkich transakcji w programie CSP przy użyciu interfejsów API lub środowiska użytkownika usługi Partner Center, zapobieganie nieautoryzowanemu dostępowi oraz ochrona ich klientów i dzierżaw przed zdarzeniami zabezpieczeń związanymi z kradzieżą tożsamości. Więcej informacji można znaleźć [tutaj.](../partner-security-requirements-mandating-mfa.md)
...
- Dostawcy pośredni muszą zaimplementować te wymagania dotyczące zabezpieczeń dla własnych firm i współpracować z odsprzedawcami, aby upewnić się, że implementują wymagania, a także za pomocą tego szablonu wiadomości e-mail. Skontaktujemy się również bezpośrednio z odsprzedawcami za pośrednictwem wiadomości e-mail.
- Odwiedź [stronę Partner Center stanu wymagań dotyczących zabezpieczeń,](https://partner.microsoft.com/commerce/security/compliance) aby zidentyfikować postęp i kluczowe działania do podjęcia. Skontaktuj się z administratorem globalnym, aby regularnie sprawdzać postęp wymagań dotyczących zabezpieczeń dla każdej z dzierżaw.
...
- Zobacz często [zadawane pytania i odpowiedzi](../partner-security-requirements-faq.yml) dotyczące wymagań dotyczących zabezpieczeń partnerów.
- Zobacz [Przewodnik sprawdzania stanu wymagań zabezpieczeń.](../partner-security-compliance.md)
- Uzyskaj dostęp do dodatkowych zasobów w [kolekcji Implementowanie wymagań dotyczących zabezpieczeń partnerów.](https://partner.microsoft.com/resources/collection/partner-security-requirements#/)
- Dodaj do [zakładek grupę społeczności Partner Center Security Guidance](https://aka.ms/MPCSecurityGuidance).

Aby uzyskać dodatkową pomoc w przypadku problemów technicznych, [prześlij bilet pomocy technicznej.](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?topicid=32674991) Przekaż tę wiadomość e-mail do innych osób w organizacji, które mogą wymagać podjęcia działań w celu zaimplementowania tych wymagań dotyczących zabezpieczeń.

Dziękujemy za partnerstwo i zobowiązanie do zapewnienia, że nasz ekosystem działa w oparciu o zaufanie.
...
- Aktualizacja z 23 kwietnia 2020 r.: Firma Microsoft będzie bezpośrednio kontaktować się z odsprzedawcami za pośrednictwem poczty e-mail.
...
- Niemcy (angielski) — poprawka do tajemnicy zawodowej dla Niemiec
- Niemcy (niemiecki) — poprawka do tajemnicy zawodowej dla Niemiec
- USA (angielski) — poprawka hipaa business associate usług online firmy Microsoft

Jak partner może uzyskać dostęp do poprawek?
...
- Krok 3. Wybierz ją, a następnie kliknij pozycję "Przejrzyj rozwiązania"
...
Oferta firmy Microsoft w zakresie ochrony punktów końcowych na serwerach (lokalnych i na platformie Azure) została Azure Security Center Standardowa. Azure Security Center standardowa kosztuje 15 USD na środowisko systemu operacyjnego serwera miesięcznie. Słyszeliśmy od klientów, że chcą mieć opcję obniżonej funkcjonalności w niższej cenie, która może zostać zakupiona w sposób zgodny z E5 w celu ochrony serwera punktu końcowego.
W odpowiedzi na potrzeby klientów wprowadzamy nową usługę Microsoft Defender ATP dla serwerów, która ma być odpowiedzią na zapotrzebowanie klientów, i oczekujemy, że większość klientów korzystających z tej sku będzie korzystać z serwerów lokalnych, jednak nie jest ona ograniczona do tego przypadku użycia. Azure Security Center Standardowa pozostaje hero SKU z rozszerzonym zestawem możliwości ochrony przed zagrożeniami, a partnerzy powinni prowadzić konwersacje z klientami z hero SKU Azure Security Center Standardowa, szczególnie w przypadku osób z obciążeniami platformy Azure. Jednak teraz firma Microsoft może zaoferować ochronę punktu końcowego w niższej cenie, aby umożliwić partnerom firmy Microsoft większą konkurencyjność na rynku ochrony punktów końcowych z usługą Microsoft Defender ATP for Servers SKU.

Klienci usługi Microsoft Defender ATP z minimalną liczbą licencji 50 mogą używać nowej jednostki SKU usługi Microsoft Defender ATP dla serwerów na potrzeby ochrony punktu końcowego serwera w wysokości 5 USD na środowisko systemu operacyjnego serwera miesięcznie. W celu zapewnienia rozszerzonej ochrony obciążeń w chmurze dla serwerów klienci korzystający z usługi Microsoft Defender ATP for Servers mogą uaktualnić jednostkę SKU do wersji Azure Security Center Standard za dodatkową kwotę 10 USD za każdy serwer OSE miesięcznie i korzystać z funkcji takich jak adaptacyjne mechanizmy kontroli aplikacji, dostęp just in time do maszyn wirtualnych, monitorowanie integralności plików i ujednolicone środowisko ochrony zasobów platformy Azure oraz dodatkowa wartość, taka jak przyszła integracja z usługą Azure Arc.

Obecnie nie ma żadnych zmian w standardzie zabezpieczeń platformy Azure. Azure Security Center Standardowa w dalszym ciągu zapewnia zintegrowane środowisko użytkownika, aby chronić nie tylko punkty końcowe maszyny wirtualnej serwera, ale także szeroki zestaw zasobów platformy Azure, w tym IoT, Usługi Azure Kubernetes (wersja zapoznawcza), Azure Container Registry (wersja zapoznawcza), Key Vault (wersja zapoznawcza), App Services, SQL i Storage.

Aby skorzystać z funkcji usługi ASC Standard, właściciele SKU serwerów muszą uaktualnić do wersji Azure Security Center (ASC) Standard z 10-stopniową sku mdatp dla właścicieli serwerów.
...
Udostępnij te informacje odpowiednim kontaktom w organizacji. W razie potrzeby może to zostać udostępnione klientom w 1:1.

W dalszej części roku będziemy udostępniać więcej informacji publicznych klientom.
...
Adres centrum operacji Microsoft Americas Operations Center w Reno w Renie w Stanach Zjednoczonych zmienia się, a wszystkie systemy, łamiąc i dokumentacja będą wymagały aktualizacji.
...
Od maja 2020 r. centrum operacji Microsoft Americas operations Center będzie mieć nowy adres.
...
Planujemy również aktywnie rozszerzyć tę ofertę na klientów z branży edukacji i instytucji rządowych w maju 2020 r., co pozwoli Ci rozszerzyć działalność i znaleźć nowe możliwości dostarczania wspaniałych ofert.

### <a name="offer-ids-impacted"></a>Identyfikatory ofert, których to miało wpływ

Oryginalny identyfikator oferty utworzony dla tego uruchomienia to: Microsoft 365 E3 dla licencji nienadzorowanych: ec3ac2d1-dd66-475a-95c8-59c32c472778
...
Microsoft 365 nienadzorowana licencja E3 umożliwia korzystanie z aplikacji pakietu Office z usługą lub innymi kontami użytkowników, co jest typowe podczas wykonywania procesu automatyzacji.

Ta nowa licencja może stanowić nową opcję do pracy z danymi i narzędziami zwiększającym produktywność, gdy nawet interfejsy API produktów, takie jak Microsoft Graph, nie spełnia wymagań automatyzacji.

### <a name="next-steps"></a>Następne kroki

Udostępnij te informacje wszystkim odpowiednim kontaktom w organizacji i sprawdź swoje ogłoszenia na [partner.microsoft.com,](https://partner.microsoft.com) aby uzyskać informacje o przyszłych aktualizacjach.

### <a name="questions"></a>Masz pytania?

W przypadku dalszych pytań dotyczących tych ofert skontaktuj się z przedstawicielem zespołu ds. konto Microsoft lub sprawdź odpowiednie społeczności usługi Yammer.

_________________

## <a name="new-opportunities-for-your-microsoft-365-education-customers-with-microsoft-365-a5-compliance"></a><a id="6"/></a>Nowe możliwości dla klientów z Microsoft 365 Education ze zgodnością Microsoft 365 A5
...
1 kwietnia 2020 r. dodatek Microsoft A5 Compliance otrzymał dodatkową wartość bez zmian cen. Ponadto wprowadziliśmy trzy miniaspektowe pakiety do obsługi nowych scenariuszy użytkownika
...
- Microsoft 365 zgodności Z A5 dla nauczycieli | 9f8f1756-f56f-421e-901a-e80e857cadb8
- Microsoft 365 zgodności A5 dla uczniów | f0f9f37a-539f-4f44-aef6-e370701494999

### <a name="microsoft-365-a5-compliance-mini-suites"></a>Microsoft 365 minizesieć zgodności A5

Od 1 kwietnia 2020 r. partnerzy firmy Microsoft mogą również oferować następujące miniaspekt. Te oferty dodatków zapewniają określone podzbiory wartości zgodności Microsoft 365 A5, zapewniając dodatkowe możliwości rozwoju klientów w określonych przypadkach użycia i potrzebach klientów.
...
- Microsoft 365 A5 eDiscovery and Audit for faculty | 5d7c0030-c2e9-4a8c-bir3-5a6dbf1e4449
- Microsoft 365 A5 EDiscovery and Audit for students | 6c6e2e9c-2156-4f7c-9c78-f94393b750fe

**Wyeychanie z usługi Office 365 Advanced Compliance and Azure Information Protection (AIP) Plan 2**

Oprócz powyższych zmian firma Microsoft wye/wyechuje usługę Office 365 Advanced Compliance and Azure Information Protection (AIP) Plan 2. Od 1 kwietnia 2020 r. te oferty nie są już dostępne w cenniku dla nowych klientów netto, a automatyczne odnawianie zostało wyłączone dla istniejących klientów.

Przedyskutuj oferty z klientami, aby poznać najlepsze dla nich rozwiązanie za pośrednictwem miniaspekt lub szerszej oferty zgodności Microsoft 365 A5.
...
## <a name="office-365-e1-trial-now-available-to-csp-partners"></a><a id="5"/></a>Wersja próbna usługi Office 365 E1 jest teraz dostępna dla partnerów programu CSP
...
Od 1 kwietnia 2020 r. można kupić nową wersję próbną usługi Office 365 E1 w programie CSP. Oferta została dostępna w cenniku, aby rozwiązać ostatni wzrost liczby zdalnych prac.
...
Z przyjemnością ogłaszamy nową wersję próbną usługi Office 365 E1 w programie CSP utworzoną specjalnie w celu obsługi odpowiedzi partnera na rosnące potrzeby dotyczące pracy zdalnej i inteligentnej. Ta oferta wersji próbnej jest dostępna od 1 kwietnia 2020 r. do odwołania.

Wersja próbna usługi Office 365 E1 dla programu CSP jest teraz dostępna jako dodatek do bieżącej wersji próbnej programu CSP usługi Microsoft Teams (bez programu Exchange i 2 GB miejsca do magazynowania). Nowa wersja próbna będzie mieć równoważną funkcjonalność wersji próbnej usługi Office 365 E1 i będzie zapewniać sześć miesięcy bezpłatnego użycia dla maksymalnie 3000 użytkowników. Ta oferta, dostępna za pośrednictwem CSP, umożliwia partnerom inicjowanie wersji próbnej i zarządzanie nim.

### <a name="offer-id"></a>Identyfikator oferty

- Nazwa wyświetlana: Wersja próbna usługi Office 365 E1
...
- [Zapoznaj się z często zadawanymi pytaniami na temat wersji próbnej usługi Office 365 E1 dla programu CSP](https://aka.ms/CSPE1OfferFAQ)
- [Dowiedz się więcej na temat wersji próbnych i ofert aplikacji Microsoft Teams](https://www.microsoft.com/microsoft-365/partners/resources/teams-offers-and-trials-comparison)
...
Jeśli masz pytania dotyczące tych ofert, sprawdź odpowiednie społeczności usługi Yammer. W przypadku innych problemów prześlij bilet pod Partner Center pomocy technicznej.
...
1 kwietnia 2020 r. firma Microsoft udostępniła nowe produkty dla usługi Dynamics Business Central Online oraz aplikacji Dynamics Biz i platform power. Dodatkowe nowe oferty dla usługi Dynamics 365 zostaną wydane 1 maja 2020 r.
...
- Aktualizowanie jednostki SKU dołączania do produktów Sales Pro i Customer Service Pro
...
1 maja 2020 r. firma Microsoft rozszerzy dostępność nowych ofert RPOA na programy edukacyjne.
...
|Nazwa wyświetlana|Zalecenia dotyczące handlu elektronicznego|Zalecenia handlowe|
...
|Wyświetlanie i PFAM|Dynamics 365 Commerce Cloud Scale Unit Premium|Dynamics 365 Commerce Scale Unit Premium — chmura|
...
- [Biz Apps Fraud Home Page](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
...
Lokalizacja zasobów gotowości operacji na partner.microsoft.com będzie działać podobnie do bieżącej galerii zasobów aktualizacji programu CSP z pewnymi ulepszeniami i modyfikacjami, w tym:
...
- **Zaawansowane wyszukiwanie w galerii:** Filtry zawartości spowadną, że znajdowanie zawartości w programach i zawartości będzie szybsze i prostsze, na przykład CSP.
...
1 kwietnia 2020 r. firma Microsoft wprowadzi Microsoft 365 Business Voice do dodatkowych lokalizacji geograficznych. Dostępne będą dwie oferty: Microsoft 365 Business Voice i Microsoft 365 Business Voice Without Calling Plan (przy użyciu routingu bezpośredniego). Obie oferty będą dostępne w Stanach Zjednoczonych.

### <a name="customer-value-proposition"></a>Ofertę wartości klienta

Microsoft 365 Business Voice to oparty na chmurze system telefonów dla firm z maksymalnie 300 użytkownikami. Zapewnia możliwość wykonywania i odbierania połączeń z dowolnego numeru telefonu w aplikacji Microsoft Teams. Wraz z zespołem zapewnia ona rozwiązanie komunikacji typu "wszystko w jednym" łączące połączenia, czaty i spotkania.

Microsoft 365 Business Voice upraszcza i usprawnia produktywność i komunikację w jednej aplikacji, która działa wszędzie, gdzie firmy: na komputerach, telefonach inteligentnych i telefonach stacjonarnych. Zalety usługi Microsoft 365 Business Voice obejmują:
...
Partnerzy mogą uzyskać przychody z tej szansy dzięki:

- Włączanie systemu telefonicznego przy użyciu kolejek wywołań/automatycznej obsługi, ocenianie jakości sieci lub konfigurowanie bezpośredniego routingu i konferencji audio.
- Oferowanie usług do wdrożenia/szkolenia użytkowników w celu zabezpieczenia gotowości organizacji i rozpoczęcia korzystania z nowoczesnego narzędzia do komunikacji Microsoft Teams.
...
- **Stany Zjednoczone tylko:** Microsoft 365 Business Voice Without Calling Plan( 39d77d0f-eb8f-4ebc-b618-692e1cc59c8f)
- **Reszta świata:** Microsoft 365 Business Voice Without Calling Plan: cc69a07c-8c51-457f-bb2a-f21a62d6bede
...
W USA i Portoryko business voice jest ofertą podatku. Cena naliczana partnerom i zapłacona przez partnerów firmie Microsoft obejmuje odpowiednie podatki i opłaty dotyczące telco w USA. Na innych rynkach podatki będą stosowane zgodnie z normalnym procesem fakturowania. Przed podjęciem decyzji o naliczaniu opłat biznesowych porozmawiaj ze swoim prawna doradcą prawnym na temat rezygnacji z podatków. Jeśli funkcja Business Voice jest oznaczona, partner musi mieć sposób na pominięcie podatków telekomunikacyjnych. W przeciwnym razie partner nie będzie płacić podatku przyrostowego na podstawie nałogów, co spowoduje naruszenia przepisów podatkowych. Firma Microsoft oferuje partnerom usługi Business Voice w USA dodatkowe zachęty dla programu CSP, aby skompensować potencjalny brak marży.

### <a name="guidance-for-partners-in-australia"></a>Wskazówki dla partnerów w Australii

Partnerzy w Australii powinni pamiętać, że oferta Microsoft 365 Business Voice Without Calling Plan nie będzie dostępna w cenniku produkcyjnym od 1 kwietnia 2020 r. — mimo że jest dostępna w cenniku wersji zapoznawczej w marcu 2020 r. Dziękujemy za zrozumienie.

### <a name="further-countries"></a>Dalsze kraje

Z czasem mamy nadzieję, że usługa Microsoft 365 Business Voice będzie dostępna we wszystkich krajach, w których są dostępne usługi Office 365 Microsoft 365 usługi.

### <a name="next-steps"></a>Następne kroki

- Sprawdź naszą galerię partnerów, aby dowiedzieć się więcej o wartości oferty tej oferty, a także ustanowić i skonsolidować swoją praktykę usługi Microsoft Teams: Microsoft 365 Business Voice w programie [CSP](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)
...
## <a name="act-now-partners-are-now-required-to-have-accepted-the-microsoft-partner-agreement"></a><a id="1"/></a>Działanie teraz: partnerzy muszą teraz zaakceptować Microsoft Partner Agreement.
...
4. Pomagaj odsprzedawcom pośrednim w wykonaniu poniższych działań.

Więcej informacji i zasobów można znaleźć na stronie galerii CSP [tutaj.](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/)

Zdajemy sobie sprawę z problemów technicznych napotykanych przez dostawców pośrednich podczas testowania możliwości wymuszania transakcyjnego. Te problemy zostaną rozwiązane do kwietnia 2020 r.
...
- 4 marca 2020 r.: seminaria internetowe z zaproszeniem zaktualizowanym na marzec 2020 r.
