...
ms.locfileid: "110325483"
---
# <a name="april-2020-announcements"></a>Ogłoszenia z kwietnia 2020 r.

Na tej stronie szczegółowo ogłoszeń dotyczących Partner Center Microsoft na kwiecień 2020 r.

Ogłoszenia na rok 2020: [styczeń 2020](2020-january.md)r. luty  |  [2020](2020-february.md)r.  |  [marzec 2020](2020-march.md) r. | Kwiecień 2020 | [Maj 2020 r.](2020-may.md)

_________________

## <a name="updated-promotions-for-office-365"></a><a id="14"/></a>Zaktualizowano promocje dla usługi Office 365
...
W ramach [zobowiązania firmy Microsoft](https://www.microsoft.com/microsoft-365/blog/2020/03/05/our-commitment-to-customers-during-covid-19/) wobec klientów w tych niezrównanych czasach dostępna była półroczna wersja próbna usługi Office 365 E1 w programie CSP dla nowych klientów (zobacz definicję poniżej).
...
- Partnerzy będą transakcyjni roczne jednostki SKU usługi Office 365 E1 lub Microsoft 365 Business Basic przy użyciu promocji programu CSP, która stosuje rabat 100% za pierwsze sześć miesięcy, a nie unikatową jednostkę SKU z sześciomiesięcznych okresów próbnych. [Dowiedz się więcej na temat promocji CSP.](../promotions.md)
...
Klienci, którzy mają obecnie licencję na wersję próbną usługi Office 365 E1 (dostępną do 4 maja 2020 r.), pozostaną w bieżącym planie — ta zmiana ma wpływ tylko na nowych klientów sieci.
...
Aby uzyskać dodatkowe pytania dotyczące tych ofert, sprawdź odpowiednie społeczności usługi Yammer i skontaktuj się z przedstawicielem w konto Microsoft usługi.
...
- Zobacz często [zadawane pytania i odpowiedzi dotyczące](../partner-security-requirements-faq.md) wymagań dotyczących zabezpieczeń partnerów.
...
Oferta firmy Microsoft w zakresie ochrony punktów końcowych na serwerach (lokalnych i na platformie Azure) została Azure Security Center Standardowa. Azure Security Center standardowa kosztuje 15 USD na środowisko systemu operacyjnego serwera miesięcznie. Od klientów słyszeliśmy, że chcą mieć możliwość obniżonej funkcjonalności w niższej cenie, która może zostać zakupiona w sposób zgodny z E5 w celu ochrony serwera punktu końcowego.
...
Każdy, kto komunikuje się z centrum operacji Americas Operations Center i komunikuje się z nim
...
Aby zapewnić najlepszą obsługę partnerów i klientów, firma Microsoft ponownie rozpocznie 1 maja 2020 r. oferty komercyjnej licencji M365 — nienadzorowane. Nie będzie to miało wpływu na cenę i możliwości.
...
Firma Microsoft planuje 1 kwietnia 2020 r. uruchomić komercyjne oferty licencji M365 — Nienadzorowane zgodnie z cennikiem wersji zapoznawczej. Po rozbudowanych testach dowiedzieliśmy się, że użytkownicy mogą napotkać nieoczekiwane zachowania podczas aprowizowania.
...
Oryginalny identyfikator oferty utworzony dla tego uruchomienia to: Microsoft 365 E3 dla licencji nienadzorowanych: ec3ac2d1-dd66-475a-95c8-59c32c4727778
...
Microsoft 365 nienadzorowana licencja E3 umożliwia korzystanie z aplikacji pakietu Office z usługami lub innymi kontami użytkowników, co jest typowe podczas wykonywania procesu automatyzacji.

Ta nowa licencja może stanowić nową opcję pracy z danymi i narzędziami zwiększającym produktywność, nawet wtedy, gdy interfejsy API produktów, takie Microsoft Graph, nie spełnia wymagań automatyzacji.

### <a name="next-steps"></a>Następne kroki

Udostępnij te informacje wszystkim odpowiednim kontaktom w organizacji i sprawdź swoje ogłoszenia na [partner.microsoft.com,](https://partner.microsoft.com) aby uzyskać przyszłe aktualizacje.

### <a name="questions"></a>Masz pytania?

W celu uzyskania dalszych pytań dotyczących tych ofert skontaktuj się z przedstawicielem zespołu konto Microsoft lub sprawdź odpowiednie społeczności usługi Yammer.

_________________

## <a name="new-opportunities-for-your-microsoft-365-education-customers-with-microsoft-365-a5-compliance"></a><a id="6"/></a>Nowe możliwości dla klientów usługi Microsoft 365 Education ze zgodnością Microsoft 365 A5
...
Wszyscy partnerzy, którzy oferują usługi Education, Dostawca rozwiązań w chmurze (CSP).
...
**Wyeechanie z usługi Office 365 Advanced Compliance and Azure Information Protection (AIP) Plan 2**

Oprócz powyższych zmian firma Microsoft wyescyplinuje usługę Office 365 Advanced Compliance and Azure Information Protection (AIP) Plan 2. Od 1 kwietnia 2020 r. te oferty nie są już dostępne w cenniku dla nowych klientów sieci, a automatyczne odnawianie zostało wyłączone dla istniejących klientów.

Omów oferty ze swoimi klientami, aby poznać najlepsze dla nich rozwiązanie za pośrednictwem miniaspekt lub szerszej oferty Microsoft 365 zgodności A5.
...
Jeśli masz pytania dotyczące tych ofert, sprawdź odpowiednie społeczności usługi Yammer. W przypadku innych problemów prześlij bilet na stronie pomocy Partner Center Technicznej.
...
Lokalizacja zasobów gotowości operacji na partner.microsoft.com będzie działać podobnie do bieżącej galerii zasobów aktualizacji programu CSP z pewnymi owalnymi ulepszeniami i modyfikacjami, w tym:
...
Microsoft 365 Business Voice, oparty na chmurze system telefonów zbudowany dla małych i średnich firm, będzie dostępny w krajach wymienionych tutaj od 1 kwietnia 2020 r.
...
1 kwietnia 2020 r. firma Microsoft wprowadzi Microsoft 365 Business Voice w dodatkowych lokalizacjach geograficznych. Dostępne będą dwie oferty: Microsoft 365 Business Voice i Microsoft 365 Business Voice Without Calling Plan (przy użyciu routingu bezpośredniego). Obie oferty będą dostępne w Stanach Zjednoczonych.

### <a name="customer-value-proposition"></a>Ofertę wartości klienta

Microsoft 365 Business Voice to oparty na chmurze system telefonów dla firm z maksymalnie 300 użytkownikami. Zapewnia możliwość wykonywania i odbierania połączeń z dowolnego numeru telefonu w aplikacji Microsoft Teams. Wraz z zespołem zapewnia ona rozwiązanie komunikacji typu "wszystko w jednym", które łączy połączenia, czaty i spotkania.

Microsoft 365 Business Voice upraszcza i usprawnia produktywność i komunikację w jednej aplikacji, która działa wszędzie, gdzie firma robi: na komputerach, telefonach inteligentnych i telefonach stacjonarnych. Zalety usługi Microsoft 365 Business Voice obejmują:
...
- Łatwe i inteligentne wywoływanie. Komunikacja z większą elastycznością, łatwością i inteligencją, dzięki czemu możesz zachować połączenie.
...
- Włączanie systemu telefonicznego z kolejkami wywołań/automatyczną obsługią, ocenianie jakości sieci lub konfigurowanie routingu bezpośredniego i konferencji audio.
- Oferowanie usług do wdrożenia/szkolenia użytkowników w celu zapewnienia gotowości organizacji i rozpoczęcia korzystania z nowoczesnego narzędzia do komunikacji, Microsoft Teams.
...
Mamy nadzieję, że z czasem usługa Microsoft 365 Business Voice będzie dostępna we wszystkich krajach, w których są dostępne usługi Office 365 Microsoft 365 usługi.

### <a name="next-steps"></a>Następne kroki

- Sprawdź naszą galerię partnerów, aby dowiedzieć się więcej o wartości oferty tej oferty, a także ustanowić i skonsolidować swoją praktykę aplikacji Microsoft Teams: dostępność usługi Microsoft 365 Business Voice w programie [CSP](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)
...
- M365 Business Voice bez uruchamiania planu połączenia: 1 kwietnia 2020 r.
