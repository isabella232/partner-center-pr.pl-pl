...
- Partnerzy będą transakcyjni roczne jednostki SKU Office 365 E1 lub Microsoft 365 Business Basic, korzystając z programu CSP Promo, który stosuje 100% rabatu przez pierwsze sześć miesięcy, a nie unikatową jednostkę SKU z 6-miesięczną próbą. [Dowiedz się więcej na temat promocji CSP.](../promotions.md)
...
Wszyscy partnerzy, którzy inicjuje transakcję M365 E3 za pośrednictwem cennika EUR w Dostawca rozwiązań w chmurze programu.
...
## <a name="reminder-activation-of-security-safeguards-for-partner-center-transactions-in-csp"></a><a id="11"/></a>REMINDER: Aktywacja zabezpieczeń zabezpieczeń dla transakcji Partner Center w programie CSP
...
Aby jeszcze bardziej ułatwić obronę partnerów i klientów, począwszy od 1 maja **2020 r.,** rozpoczniemy aktywację zabezpieczeń przed Partner Center transakcji w programie CSP. Aktywacja dodatkowych zabezpieczeń oznacza, że partnerzy będą proszeni o użycie uwierzytelniania wieloskładnikowego (MFA) dla wszystkich transakcji w programie CSP przy użyciu środowiska użytkownika lub interfejsów API usługi Partner Center, co zapobiega nieautoryzowanemu dostępowi oraz chroni ich klientów i dzierżawców przed zdarzeniami zabezpieczeń związanymi z kradzieżą tożsamości. Aby uzyskać więcej [informacji, zobacz Temat Wymuszanie uwierzytelniania wieloskładnikowego (MFA) dla dzierżawy partnera.](../partner-security-requirements-mandating-mfa.md)
...
- Odwiedź [stronę Partner Center stan wymagań dotyczących zabezpieczeń,](https://partner.microsoft.com/commerce/security/compliance) aby zidentyfikować postęp i kluczowe działania do podjęcia. Skontaktuj się z administratorem globalnym, aby regularnie sprawdzać postęp wymagań dotyczących zabezpieczeń dla każdej dzierżawy.
...
- Dodaj do [zakładek Partner Center społeczności wskazówek dotyczących zabezpieczeń.](https://aka.ms/MPCSecurityGuidance)
...
- Niemcy (angielski) — poprawka Professional dotyczące tajemnicy dla Niemiec
...
Aby uzyskać więcej informacji na temat Umowa z Klientem Microsoft, odwiedź kolekcję na stronie [New Umowa z Klientem Microsoft in the CSP program, October 1, 2019 ( Nowy Umowa z Klientem Microsoft w programie CSP, 1 października 2019 r.](https://partner.microsoft.com/resources/collection/Microsoft-Customer-Agreement-in-the-CSP-program#/)
...
W przypadku dalszych pytań dotyczących tych ofert skontaktuj się z przedstawicielem w zespole ds. konto Microsoft lub sprawdź swoje Yammer społeczności.
...
Wszyscy partnerzy, którzy oferują usługi Education, Dostawca rozwiązań w chmurze programem Dostawca rozwiązań w chmurze (CSP).
...
- Microsoft 365 A5 Information Protection i ład dla uczniów | a91941ff-79a2-4476-a064-c5a6922e0bbd
...
Oprócz powyższych zmian firma Microsoft wyescyplinuje Office 365 Advanced Compliance i Azure Information Protection (AIP) Plan 2. Od 1 kwietnia 2020 r. te oferty nie są już dostępne w cenniku dla nowych klientów sieci, a automatyczne odnawianie zostało wyłączone dla istniejących klientów.
...
Wersja próbna Office 365 E1 CSP jest teraz dostępna jako dodatek do bieżącej wersji próbnej Microsoft Teams CSP (która nie ma Exchange ani 2 GB miejsca do magazynowania). Nowa wersja próbna będzie mieć równoważną funkcjonalność z Office 365 E1 próbną i będzie zapewniać sześć miesięcy bezpłatnego użycia dla maksymalnie 3000 użytkowników. Ta oferta, dostępna za pośrednictwem CSP, umożliwia partnerom inicjowanie wersji próbnej i zarządzanie nim.
...
## <a name="microsoft-365-business-voice-available-to-csp-partners-from-april-1-2020"></a><a id="2"/></a>Microsoft 365 Business Voice są dostępne dla partnerów CSP od 1 kwietnia 2020 r.
...
Microsoft 365 Business Voice upraszcza i usprawnia produktywność oraz komunikację w jednej aplikacji, która działa wszędzie, gdzie robią to firmy: na komputerach, telefonach inteligentnych i telefonach stacjonarnych. Korzyści wynikające z Microsoft 365 Business Voice obejmują:
...
- **Stany Zjednoczone:** Microsoft 365 Business Voice bez wywoływania planu: 39d77d0f-eb8f-4ebc-b618-692e1cc59c8f
...
Mamy nadzieję, że z czasem będziemy Microsoft 365 Business Voice we wszystkich krajach, w których Office 365 i Microsoft 365 są dostępne.
...
Informacje i zasoby dotyczące odsprzedawcy pośredniego są dostępne w ramach dołączania odsprzedawcy pośredniego [Microsoft Partner Agreement w kolekcji programów CSP.](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/)
