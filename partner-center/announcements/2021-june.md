...
Najnowszy przewodnik globalna gotowość do promocji, skonsolidowany widok wszystkich bieżących i nadchodzących promocji, jest teraz dostępny w galerii zasobów Operations Readiness. Zobacz aktywne i nadchodzące promocje oraz oferty w [kolekcji Global Promo Readiness Guide](https://partner.microsoft.com/resources/collection/global-promo-readiness-guide-collection#/)(Globalny przewodnik dotyczący gotowości na promocje).
...
________________
## <a name="cloud-solution-provider-csp-promo-extensions-for-microsoft-365-audio-conferencing-and-microsoft-365-business-voice"></a><a name="5"></a>Dostawca rozwiązań w chmurze (CSP) dla Microsoft 365 audiokonferencji i Microsoft 365 Business Voice 
...
1. Nieprawidłowe ceny w niektórych walutach.
   ...
   - Problemy z cenami zostały wykryte wystarczająco wcześnie, aby upewnić się, że partnerzy zostaną zafakturowane w prawidłowych kwotach, jeśli zostaną naliczeni za wszelkie zakupy od momentu wystawienia nieprawidłowych cen. Partnerzy, których to miało wpływ, zobaczą na fakturze środków na korektę faktury.
     ...
     - Partnerzy zostaną zafakturowane kwoty z maja, jeśli będą niższe niż kwoty z czerwca 3.
...
Office 365 E1 ofert organizacji non profit zostały niepoprawnie oflagowane jako del (usunięte) w cenniku wersji zapoznawczej z lipca. Zaktualizowany cennik wersji zapoznawczej został opublikowany 4 czerwca 2021 r. i poprawiono literówkę.
