...
Ogłoszenia dotyczące roku 2020: kwiecień [](2020-april.md)  |  [maj](2020-may.md)  |  [](2020-june.md)  |  [czerwca](2020-july.md)  |  [sierpień](2020-august.md)  |  [wrzesień](2020-september.md)  |  [|](2020-October.md) Listopada
...
Firma Microsoft wprowadza możliwość zakupu ofert SaaS przez partnerów programu Dostawca rozwiązań w chmurze z rozliczeniami mierzonymi w Partner Center. 
...
## <a name="office-365-e1-for-mid-market-promo-latam-apac-and-india"></a><a name="12"></a>Office 365 E1 dla średniego rynku (LATAM, APAC i Indie)
...
- Partner współpracuje z nowymi lub istniejącymi klientami w następujących krajach: Nawiązano współpracę z następującymi krajami: Armenią (AM), Armenią (AZ), Armenią (BY), Armenią (KZ), Kyrgyzstan (KG), Kolumbią (RU), Tadżykistanem (TJ), Stanami (UZ) i Stanami (UA) 

W przypadku takich partnerów z klientem w tych krajach partner będzie  teraz miał możliwość przesyłania identyfikatora prawnego określonego klienta (znanego także jako organizacja **KLIENTA** klienta ) i numeru **Telefon** klienta, gdy partner spróbuje zaktualizować lub utworzyć subskrypcję dla tego klienta. Ci partnerzy mogą teraz również wprowadzić opcjonalne, środkowe **imię** klienta.
...
| Mołdawia  | CEE        | MD               | 6, 7, 8 lub 13 cyfr         | :::no-loc text="IDNO/IDNP"::: | Unikatowy numer identyfikacyjny stanu (IDNO) przypisany do jednostki prawnej jest również dzielony jako kod obrachunkowy. \"Rejestr stanowy jednostek prawnych dotyczący firm zarejestrowanych w Republice Ludowej opublikowany przez Rządową Agencji Ds. Technologii Informatycznych i Komunikacyjnych w portalu rządowym organizacji, w którym są otwarte data.gov.md.\"                    |
...
## <a name="euefta-change-of-partner-billing-currency-for-new-commerce-offers"></a><a name="10"></a>Zmiana waluty rozliczeniowej partnera dla nowych ofert handlowych w Unii Europejskiej/KRAJACH.  
...
W regionie Unii Europejskiej (UE)/Europejskiego Związku Wolnego Handlu (EUROPEAN) wszystkie nowe oferty handlowe w programie Dostawca rozwiązań w chmurze będą używać lokalizacji rozliczeń partnera zamiast lokalizacji rozliczeń klienta. Oznacza to, że partnerzy będą rozliczani przez firmę Microsoft na podstawie ich waluty lokalizacji, a nie waluty lokalizacji ich klientów. Zostanie to zrobione w dwóch fazach: 

- **Faza 1: Nowi klienci kupują nową ofertę handlową w programie CSP**

Od stycznia 2021 r. partnerzy, którzy mają nowych klientów kupujących nowe oferty handlowe, będą rozliczani za te zakupy w walucie lokalizacji partnera. Partnerzy z istniejącymi klientami, którzy już kupili nowe oferty handlowe w programie CSP, będą nadal rozliczani w walucie lokalizacji rozliczeniowej klienta w tej fazie. 
...
Nowe oferty handlowe w zakresie tej zmiany to: subskrypcje platformy Azure, które są częścią planu platformy Azure, rezerwacje platformy Azure, subskrypcje serwerów, bezterminowe oprogramowanie i zakupy na platformie handlowej firmy Microsoft Dostawca rozwiązań w chmurze programie.
...
- Partnerzy zauważą ograniczoną złożoność rozliczeń spowodowaną przez fakturowanie w wielu walutach, które spowoduje skrócenie czasu i zasobów skojarzonych obecnie z uzgadnianiem kont. 
...
Zapoznaj się z informacjami na ten temat w witrynie internetowej partnerów firmy Microsoft & [EU/COMMERCE Change of Partner Billing Currency](https://partner.microsoft.com/resources/collection/eu-efta-changes-collection#/) for new commerce offers (Zmiana waluty rozliczeniowej partnera w Zjednoczonym Królestwie dla nowych ofert handlowych).  
...
Firma Microsoft implementuje ograniczanie interfejsów API w I kwartale 2021 r., aby zapewnić bardziej spójną wydajność w okresie dla partnerów wywołujących interfejsy API Partner Center API. Ograniczanie ogranicza liczbę żądań do usługi w określonym czasie, aby zapobiec wywłasznianiu zasobów. Po przekroczeniu progu ograniczania Partner Center ograniczy wszelkie dalsze żądania od tego klienta przez określony czas.  
...
|{baseURL}/v1/customers/{identyfikator-dzierżawy-klienta}/transfers|[Pobierz wszystkie przelewy klienta](/partner-center/develop/get-subscription-registration-status)| 
...
Przejrzyj [wskazówki dotyczące ograniczania interfejsu API](/partner-center/develop/api-throttling-guidance)i podjąć niezbędne kroki. 
...
- W ramach tego partnera zmiany zażądano, aby partnerzy uwzględnili parametr typu umowy zgodnie z dokumentacją w zasobach karty stawki platformy Azure, aby uzyskać bieżące ceny platformy Azure w ofercie platformy Azure w Twoim [regionie.](/partner-center/develop/get-confirmation-of-customer-agreement)
...
- We wrześniu 2020 r. wysłaliśmy powiadomienie do partnerów za pośrednictwem Yammer na wielu forach z prośbą o naprawienie parametru przez partnerów. Firma Microsoft nie może już akceptować duplikatów i otrzyma błędy 409.
...
- Obecnie przypominamy partnerom, a także wysyłamy osobiste wiadomości e-mail do 10 najbardziej odmówień, aby przejrzeli ich żądania i spisali się do nas, abyśmy pomogli im przetestować i rozwiązać problem.
...
- Jednak 14 stycznia 2021 r. ponownie nie będziemy akceptować duplikatów. Pozwala to partnerom na dalsze dostosowanie po swojej stronie. Otrzymaliśmy już powiadomienie od partnera, że planuje on wdrożyć aktualizację 11/16, nad którą będziemy ściśle współpracować.
...
## <a name="testing-available-partner-center-api-and-user-interface-ui-enhancements-for-the-education-customer-validation-process"></a><a name="7"></a>Dostępne testowanie: Partner Center interfejsu API i interfejsu użytkownika na potrzeby procesu weryfikacji klientów w edukacji
...
Nowa dodatku Advanced Communications SKU dla usługi Microsoft Teams w GCC będzie dostępna od 1 grudnia 2020 r.
...
Informacje na temat mapowania lokalnych praw podwójnego użycia usługi Dynamics 365 dla ofert Project Operations można znaleźć w poniższej tabeli:
   ...
   |-------------------|:------|
   |Oferta operacji D365|Lokalne mapowanie praw podwójnego użycia usługi D365|
   |Operacje Project D365|D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477) (D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)|
   |Dołączanie operacji Project D365|D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477) (D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)|
   |D365 Finance with Project Operations|D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477) (D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)|
   |Dołączanie danych finansowych do Project D365|D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477) (D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)|
   |Ujednolicone operacje D365 — działanie z Project operacji|D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477) (D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)|
