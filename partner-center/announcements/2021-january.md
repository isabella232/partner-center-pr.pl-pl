...
**Odsprzedawcy pośredni:** Jeśli nie zaakceptowaliśmy mpA, przejrzyj często zadawane pytania dotyczące [mpa](../mpa-indirect-provider-faq.yml) i postępuj zgodnie ze wskazówkami krok po kroku dostępnymi w temacie Informacje o programie [Microsoft Partner Agreement (MPA)](../microsoft-partner-agreement.md) dla partnerów programu CSP, aby zaakceptować to mpa.

**Dostawcy pośredni:** Skontaktuj się ze swoimi odsprzedawcami pośrednimi i wspieraj ich, korzystając z często zadawanych pytania dotyczących [mpa](../mpa-indirect-provider-faq.yml) oraz wskazówek krok po kroku dostępnych w temacie Informacje na temat Microsoft Partner Agreement [(MPA)](../microsoft-partner-agreement.md)dla partnerów programu CSP.
...
W fazie 1 wszystkie nowe usługi Dostawca rozwiązań w chmurze Azure będą w nowej ofercie planu platformy Azure. Będą stosowane następujące wytyczne:
...
Należy również pamiętać, że obecnie możliwość realizacji klucza Partner Center oprogramowania i licencji została wycofana, a partnerzy w przyszłości powinni w tym celu wskazać klientom centrum Administracja Microsoft 365 licencji. Szczegółowe informacje i kolejne kroki można znaleźć poniżej.

### <a name="next-steps"></a>Następne kroki

- Pobierz cennik **oprogramowania bezterminowego** programu CSP w sekcji **Oprogramowanie** na stronie Partner Center [cennika & oprogramowania.](https://partnercenter.microsoft.com/pcv/sales) Listę nowo dodanych produktów i lokalizacji geograficznych można znaleźć w galerii zasobów [Operations Readiness.](https://partner.microsoft.com/resources/detail/software-in-csp-new-products-geos-pdf)
- Zapoznaj się [z Administracja Microsoft 365 center](/microsoft-365/admin/setup/download-software-licenses-csp) oprogramowania i kluczy licencji produktów, aby pobrać artykuł z ięciami i udostępnić je klientom, gdy będą gotowi do pobrania ich oprogramowania i kluczy licencji.
...
Firma Microsoft będzie implementować ograniczanie interfejsów API, aby zapewnić bardziej spójną wydajność w okresie dla partnerów wywołujących interfejsy API Partner Center API.
...
Zdecydowanie zalecamy, aby partnerzy rozważyli użycie interfejsu API dziennika aktywności w celu zwiększenia wydajności i uniknięcia ograniczania.Aby uzyskać więcej informacji na temat tej funkcji, zapoznaj się ze szczegółami w te tematu [API throttling guidance for partners calling Partner Center APIs (Wskazówki dotyczące](/partner-center/develop/api-throttling-guidance)ograniczania interfejsów API dla partnerów wywołujących interfejsy API interfejsów API Partner Center API).  
...
Przejrzyj podgląd cennika i udostępnij go odpowiednim uczestnikom projektu w organizacji. Aby uzyskać więcej informacji, przejdź do [tematu Zabezpieczenia i](https://techcommunity.microsoft.com/t5/microsoft-security-and/ct-p/MicrosoftSecurityandCompliance)zgodność firmy Microsoft — Microsoft Tech Community .
...
Jeśli masz jakieś pytania, skontaktuj się z regionalne centrum operacyjne za pomocą narzędzia [call Logging Tool (CLT)](https://clt.partners.extranet.microsoft.com/CLT) lub zapoznaj się z [tematem Explore MS](https://www.explore.ms/). Dokładnie postępuj zgodnie ze standardowym procesem CLT, abyśmy w miarę możliwości rozpoznali Twoje zapytanie.
...
Od 1 marca 2021 r. ceny norweskich produktów w przypadku komercyjnego oprogramowania lokalnego i Usługi online zmienią się w celu wyrównania z obowiązującymi poziomami cen w regionie.
...
Firma Microsoft wprowadza zmiany w cenniku rupia indyjska w celu dostosowania cen oprogramowania komercyjnego i Usługi online w Indiach i regionie Azji. Gdy staną się dostępne, będziemy publikować więcej szczegółów. Jeśli w międzyczasie potrzebujesz pomocy, skontaktuj się z Partner Center [pomocą techniczną.](https://partner.microsoft.com/support/?stage=1)
...
Oferta dodatku w pakiecie dla ofert Microsoft 365 E1, E3 i E5 obejmuje system telefoniczny i krajowe plany połączeń. Ponadto nowa autonomiczna oferta planu połączeń krajowych będzie dostępna tylko na platformie E5. Nowe oferty będą dostępne tylko dla klientów w Stanach Zjednoczonych, Portoryko i Kanadzie. w przypadku wszystkich innych krajów i terytoriów istniejące globalne autonomiczne jednostki SKU i ceny pozostają bez zmian. 
