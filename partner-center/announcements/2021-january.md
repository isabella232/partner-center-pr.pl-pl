...
Zgodnie z zapowiedzią dzisiaj z przyjemnością informujemy, że udostępniliśmy dwa nowe typy operacji w dziennikach aktywności usługi Partner Center, aby zapewnić widoczność partnerom, gdy klient zatwierdzi lub usunął delegowane relacje administratora.
...
- [Inspekcja zasobów — Partner Center deweloper aplikacji | Microsoft Docs](/partner-center/develop/auditing-resources)

### <a name="questions"></a>Masz pytania?

Jeśli masz dodatkowe pytania, sprawdź swoje odpowiednie Yammer CSP.
...
Dzięki nowej wersji handlowej partnerzy uzyskują dostęp do usług platformy Azure z płatnością zgodnie z płatnością zgodnie z Umowa z Klientem Microsoft za pośrednictwem planu platformy Azure. Ten plan upraszcza środowisko zakupu, umożliwiając tworzenie wielu subskrypcji platformy Azure w ramach planu platformy Azure. Nie ma już potrzeby przesyłania oddzielnego zamówienia na subskrypcję platformy Azure w Partner Center.

#### <a name="changes-to-the-previous-azure-offer-availability-in-the-cloud-solution-provider-program"></a>Zmiany w dostępności poprzedniej oferty platformy Azure w programie Dostawca rozwiązań w chmurze platformy Azure

Po ogłoszoniu nowej oferty platformy Azure w programie Dostawca rozwiązań w chmurze (plan platformy Azure) poinformujeliśmy partnerów, że poprzednia oferta i platforma Azure będą przez pewien czas dostępne razem z nowym środowiskom platformy Azure oraz że poinformujemy partnerów z sześciu miesięcy wcześniej, zanim zostaną wprowadzone jakiekolwiek zmiany w poprzedniej ofercie platformy Azure.

Nowa oferta platformy Azure w programie Dostawca rozwiązań w chmurze (plan platformy Azure) zapewnia partnerom ulepszone środowisko, ale chcemy dać partnerom czas na uwzględnienie nowych funkcji platformy Azure z ich usługami i przejście klientów do nowego doświadczenia.
...
- Zapoznaj się [z Administracja Microsoft 365](/microsoft-365/admin/setup/download-software-licenses-csp) center oprogramowania i kluczy licencji produktów, aby pobrać artykuł z ięciami i udostępnić je klientom, gdy będą gotowi do pobrania ich oprogramowania i kluczy licencji.
...
Jeśli masz dodatkowe pytania, sprawdź odpowiedniego Yammer CSP.

### <a name="change-log"></a>Dziennik zmian:

- 19 stycznia 2021 r.: oryginalna publikacja 

- 5 marca 2021 r.: Dodano uwagę u góry dotyczącą możliwości Partner Center oprogramowania i klucza licencji
...
Partner Center jest przeznaczona do obsługi dużej liczby żądań, ale w przypadku dużej liczby żądań składanych przez kilku partnerów ograniczanie przepływności pomoże zachować optymalną wydajność i niezawodność dla wszystkich partnerów.  
...
|{baseURL}/v1/customers/{identyfikator-dzierżawy-klienta}/transfers  | [Pobierz wszystkie przeniesienia klienta](/partner-center/develop/get-all-of-a-customer-s-transfers) |
...
Istniejący bezpośredni i pośredni partnerzy Dostawca rozwiązań w chmurze (CSP) w ramach MPA. Partnerzy w 2017 r. w 1997 roku będą wymagać od partnerów w 1999 r. podpisania umowy rocznej lub elektronicznej.
...
Od 1 marca 2021 r. norweskie ceny krony za komercyjne oprogramowanie lokalne Usługi online zmienią się, aby zrównoważyć obowiązujące poziomy cen w regionie.
...
Wkrótce pojawi się dodatkowa oferta usługi Microsoft 365, która będzie obejmować usługi system telefoniczny i krajowe plany połączeń oraz autonomiczny krajowych planów połączeń telefonicznych, która będzie wkrótce wybierać kraje.
...
- Administratorzy globalni dzierżaw, których to problem, którzy kupili subskrypcje od 1 stycznia do 6 stycznia, zostaną powiadomieni za pośrednictwem wiadomości e-mail Partner Center do końca stycznia ze szczegółami. 
...
Partnerzy sprzedawani oferty Academic za pośrednictwem programu Dostawca rozwiązań w chmurze przy użyciu interfejsu API Partner Center API
...
- Przejrzyj nowe zmiany interfejsu API Partner Center i Przewodnik w zasobach gotowość do [operacji: Partner Center edukacji](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)i weryfikacji klientów .
...
Partnerzy biorący udział w programie zachęt odsprzedawcy bezpośredniego Dostawca rozwiązań w chmurze (CSP), dostawcy pośredniego i odsprzedawcy pośredniego
...
Środowisko autonomiczne "Customer Service Szczegółowe informacje" przenosi się do usługi "Dynamics 365 Customer Service", w której klienci mogą znaleźć te same możliwości głęboko osadzone w funkcjach obsługi klienta.  
