...
## <a name="partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="8"></a>Partner Center interfejsu API i ulepszenia interfejsu użytkownika na potrzeby procesu weryfikacji klientów w edukacji
...
Oprócz powyższych ulepszeń z przyjemnością ogłaszamy, że w 2. kwartale 201 r. włączymy oferty o cenie akademickiej dla klientów biblioteki i edukacji, rozszerzając klientów z instytucji edukacyjnych, za pomocą których można transakcje ofert CSP.
...
- Ogranicza przyszłe opracowywanie, ponieważ większość bibliotek będzie wydawana dla programu .NET Core lub .NET Standard, co może nie obsługiwać bieżącej wersji struktury.
...
## <a name="new-microsoft-teams-advanced-communications-skus-are-now-available"></a><a name="4"></a>Nowe Microsoft Teams SKU komunikacji zaawansowanej są teraz dostępne
### <a name="categories"></a>Kategorie
...
Nowe dodatkowe jednostki SKU komunikacji zaawansowanej dla Microsoft Teams stały się dostępne 1 sierpnia 2020 r.
...
Od 1 sierpnia 2020 r. firma Microsoft wydała nową ofertę pakietu Dynamics 365 Sales Premium dla klientów we wszystkich programach oraz w krajach i regionach, w których są już dostępne usługi Dynamics 365 Enterprise i Dynamics 365 Sales Szczegółowe informacje.
...
## <a name="announcing-the-availability-of-visio-plan-1-and-plan-2-trial-offers"></a><a name="1"></a>Announcing the availability of Visio (plan 1) and Plan 2 Trial Offers (Ogłaszamy dostępność ofert wersji próbnej Visio (plan 1) plan 2) 
...
Rozwiązania Visio Microsoft mogą być używane w różnych branżach i rolach z integracją Microsoft 365, Microsoft Teams i Power Platform rozwiązań. Zapewnij klientom narzędzia potrzebne do prowadzenia działalności.
...
- Zalecamy również zapoznanie się z sesją Inspire (Inspiruj) na temat pomagania klientom w [rebound and reimagine businesses with Microsoft Visio and Power Platform](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform).
