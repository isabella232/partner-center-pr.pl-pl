...
Partnerzy biorący udział w programie zachęt dla Dostawca rozwiązań w chmurze (CSP), dostawcy pośredniego i odsprzedawcy pośredniego
...
Nowa Microsoft Edge jest naszym najlepszym wyrażeniem nowoczesnej przeglądarki i z przyjemnością informujemy klientów o tym. Teraz, gdy wysłaliśmy nową aplikację Microsoft Edge i uaktualniliśmy większość naszych klientów usługi Windows 10 do nowej przeglądarki, kończymy obsługę starszej Microsoft Edge klasycznej.

**Wpływ zmiany**

- Od **30 listopada 2020** r. klienci nie mogą już łączyć się z aplikacją internetową Microsoft Teams w dniu 11 Internet Explorer 11. Firma Microsoft uważa, że klienci będą korzystać z Microsoft 365 i najlepszego wyrażenia nowoczesnej przeglądarki podczas korzystania z nowego [Microsoft Edge.](https://www.microsoft.com/edge/business?form=MO12H3&OCID=MO12H3)
- Po 9 marca **2021** r. aplikacje i witryny utworzone dla starszej wersji usługi Microsoft Edge będą nadal działać w nowym Microsoft Edge, ale jeśli pojawi się problem ze zgodnością, istnieje obietnica zapewnienia pomocy technicznej dla aplikacji [App Assure.](/fasttrack/products-and-capabilities#app-assure)
...
Obecnie, w ramach [](https://blogs.partner.microsoft.com/mpn/expanding-opportunities-for-partners-in-the-cloud-solution-provider-program/)ustalania priorytetów dla chmury, zapewniamy informacje o przyszłych zmianach dla klientów sektora publicznego (instytucji rządowych, instytucji edukacyjnych i niedochodowych) kupowanych za pośrednictwem programu Licencjonowanie otwarte, a także o powiązanych zmianach w programie Dostawca rozwiązań w chmurze.
...
- [Program CSP Bezterminowe oprogramowanie i lokalizacje geograficzne](https://partner.microsoft.com/resources/detail/software-in-csp-new-products-geos-pdf) dodane 19 stycznia 2021 r.
...
- Partnerzy będą musieli zakupić ofertę bez rabatu (identyfikator oferty: 5e1087b6-246b-4503-b88a-b60bdf0b3840) przed wygaśnięciem 12 miesięcy, jeśli chcą nadal korzystać z usług oferowanych w ramach początkowej oferty promocyjnych.
...
Cenniki oparte na licencji z grudnia zawierają poniższe oferty, które nie powinny być w cennikach. Te oferty zostały wcześniej uwzględnione w cennikach w błędzie i nie powinny zostać opublikowane. Nie ma harmonogramu, kiedy te oferty mogą być dostępne. W przyszłości, jeśli zostaną dodane ponownie, zostaną one wymienione jako ADD w cennikach w przyszłej wersji zapoznawczej.
...
Poniższe oferty były w macierzy listy ofert o błędzie. Nie są one dostępne, nie ma jeszcze daty docelowej dostępności. Partnerzy powinni zignorować te elementy wiersza.
   ...
   |**Nazwa oferty**|**Identyfikator oferty**|
   |-------------------|:------|
   |Operacje usługi Dynamics 365 — pojemność bazy danych (cennik dla organizacji non profit)|1d3f4d81-89b9-419e-a880-31b2c50b8d666|
...
## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a>Wkrótce zostanie w nim w wersji usłyszanych Microsoft 365 Business Voice oferty planu wywołań
...
1 stycznia 2021 r. firma Microsoft rozpocznie przechodzenie partnerów i klientów z USA do nowej Microsoft 365 Business Voice oferty planu połączeń. Nie jest wymagana żadna akcja partnerska.
...
Oprócz powyższych ulepszeń z przyjemnością ogłaszamy, że włączymy oferty w cenie akademickiej dla klientów biblioteki i biblioteki, rozszerzając klientów edukacyjnych, u których można transakcjować oferty CSP. 
...
- Zapoznaj się z nowymi Partner Center Interfejs użytkownika, zmianami interfejsu API i przewodnikiem w zasobach gotowość do operacji:  [Partner Center Edukacji](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) ulepszenia procesu weryfikacji klientów 
