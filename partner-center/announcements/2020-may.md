...
- Bieżący PartnerSource Business Center (PSBC) muszą zrezygnować z automatycznego wybrań dla swoich klientów, aby zapobiec automatycznemu odnowieniu planu EP na następny rok.

### <a name="order-process"></a>Proces zamawiania

Aby skorzystać z tej oferty, wymagane są następujące kroki WSP i EP:

1. Kup usługę Dynamics 365 Business Central Usługi online sKU.
...
### <a name="summary"></a>Podsumowanie
Nowe oferty dla programu RPA in Education wydanego 1 maja 2020 r.
