...
description: Ogłoszenia dotyczące platformy Microsoft Partner Center, takie jak nowe możliwości, promocje, oferty, rynki lub zmiany istniejących ofert, mogą zostać ogłoszone w maju 2020 r.
ms.topic: article
...
Ogłoszenia na rok 2020: [styczeń 2020](2020-january.md)r. luty 2020 r. marzec  |  [](2020-february.md)  |  [2020](2020-march.md)r.  |  [kwiecień 2020](2020-april.md) r. | Maj 2020 r.
...
Microsoft 365 A3 — oferta licencji nienadzorowanych dla usług Education została uwzględniona w cenniku wersji zapoznawczej, który został opublikowany z błędem.
...
Należy pamiętać, że oferta odnowienia umowy CSP-EP jest nową opcją dla klientów w celu odnowienia ich ep-ep. Klienci będą nadal mieć możliwość corocznego odnawiania swoich ep za pośrednictwem DPL na potrzeby rozwiązania lokalnego.
...
Partnerzy muszą zapewnić zgodność swoich klientów przez cały rok. Klienci, którzy nie pozostaną aktywni w cSP, powróci do EP i będą odpowiedzialni za wszystkie naliczane opłaty.
...
1. Kup usługę Dynamics 365 Business Central Usługi online SKU(s).
   ...
   |Dynamics 365 Business Central Team Members Cloud Add-on from DPL|   5d628802-49ce-4c84-954f-1a2170de1ac7|Członkowie zespołu dynamics 365 Business Central|
...
- Osoby, które nie zostały w pełni zmigrowane do usługi Dynamics 365 Business Central Usługi online, jeśli są uprawnione, mogą zdecydować się na dalsze odnowienie oferty odnowienia programu CSP-EP przez dwa dodatkowe lata (łącznie trzy lata).
...
Partnerzy oferują usługę Dynamics 365 za pośrednictwem programu Dostawca rozwiązań w chmurze (CSP) na całym świecie (chyba że określono inaczej).
