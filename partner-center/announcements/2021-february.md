...
- Przejrzyj nowe zmiany interfejsu API Partner Center i Przewodnik w zasobach gotowość do operacji: ulepszenia procesu weryfikacji klienta [Partner Center Education.](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)
...
Partnerzy z transakcjami w ramach umowy PSC mogą teraz szybciej korzystać z nowego środowiska sprzedaży w ramach usługi Partner Center i wyeliminować pracę na dwóch platformach przez migrację transakcji sprzedaży do Partner Center przy użyciu funkcji migracji transakcji.
