...
ms.locfileid: "128309743"
---
# <a name="september-2020-announcements"></a>Ogłoszenia z września 2020 r.

Na tej stronie szczegółowo ogłoszeń dotyczących usługi Microsoft Partner Center na wrzesień 2020 r.

Ogłoszenia dotyczące roku 2020: [luty](2020-february.md)  |  [marzec](2020-march.md)  |  [kwiecień](2020-april.md)  |  [maj](2020-may.md)  |  [](2020-june.md)  |  [czerwiec lipca](2020-july.md)  |  [|](2020-august.md) Września

________________
## <a name="partner-center-software-license-key-and-download-fulfillment-notice"></a><a name="17"></a>Partner Center klucza licencji oprogramowania i powiadomienia o realizacji pobierania
...
Wszyscy partnerzy z firmy Cloud Solution Partner (CSP) transakcją ofert oprogramowania

### <a name="details"></a>Szczegóły

>[!NOTE]
>Ze względu na opinie partnerów przywracamy możliwość realizacji Partner Center uzyskiwania kluczy oprogramowania i licencji dla bezterminowych zamówień oprogramowania i zamówień oprogramowania subskrypcji serwera. Zostanie on przywrócony do poprzedniego stanu przed usunięciem 19 stycznia 2021 r. Aby uzyskać więcej informacji, zobacz [anons z marca 2021 r.](./2021-march.md#4).

Obecnie partnerzy mogą używać programu Partner Center lub centrum Administracja Microsoft 365 do pobierania oprogramowania i realizacji klucza licencji dla zamówień oprogramowania CSP. Od **19 stycznia 2021** r. możliwość realizacji oprogramowania i klucza licencji usługi Partner Center zostanie wycofana,  a partnerzy będą wskazać klientom, aby w tym celu korzystali wyłącznie z Centrum Administracja Microsoft 365. Strona Oprogramowanie klienta w Partner Center będzie zawierać "link głęboki" do Centrum Administracja Microsoft 365, na którym można wskazać klientom uzyskiwanie licencji klienta i pobierania oprogramowania. Pomaga to zapewnić klientom najbezpieczniejsze i najbardziej wydajne środowisko.

Klucze licencji na oprogramowanie i linki do pobierania są cennymi i wysoce pożądanymi zasobami własności intelektualnej. W przypadku wycieku mogą one szybko zostać wyczerpane limity aktywacji i spowodować negatywne doświadczenia klientów i partnerów. W związku z tym niezwykle ważne jest, aby partnerzy korzystali z najbezpieczniejszych technologii i najlepszych rozwiązań, aby chronić te cenne zasoby i chronić swoich klientów.

**Administracja Microsoft 365 Centrum**

Centrum Administracja Microsoft 365 Zwiększa bezpieczeństwo dostarczania zakupionego oprogramowania i umożliwia klientom zarządzanie swoimi subskrypcjami i samoobsługowe korzystanie z nich w dogodnym czasie, co poprawia jakość obsługi klienta. Zmniejsza to ryzyko związane z kopiowaniem i wysyłaniem kluczy licencji bezpośrednio do klienta, tak jak w przypadku korzystania z Partner Center. Jako dodatkowy środek bezpieczeństwa wszystkie działania partnerów dotyczące uzyskiwania dostępu do kluczy oprogramowania i pobierania ich oraz dostarczania są śledzone w Partner Center aktywności. Dzięki tej funkcji rejestrowania aktywności partnerzy mogą śledzić dostęp użytkowników wewnętrznych w celu tworzenia zamówień, pobierania kluczy i pobierania oraz większej kontroli i zmniejszenia potencjalnego ryzyka oszustwa.

### <a name="next-steps"></a>Następne kroki

- Aby dowiedzieć się więcej o oprogramowaniu Administracja Microsoft 365 [Center,](https://support.microsoft.com/office/admin-center-overview-fa715fa8-6eda-456d-b177-d1c156edd1b3)zapoznaj się z omówieniem , [typowych](/microsoft-365/admin/admin-overview/about-the-admin-center?view=o365-worldwide&preserve-view=true) zadań i możliwości realizacji [klucza licencji.](https://partner.microsoft.com/resources/detail/microsoft-365-admin-center-software-key-download-pdf)
...
- 30 września 2020 r.: oryginalna publikacja 

- 5 marca 2021 r.: W górnej części strony dodano uwagę dotyczącą ponownego Partner Center możliwości realizacji klucza licencji i oprogramowania.

________________
## <a name="cloud-solution-provider-csp-program-evolution-and-open-license-program-changes-journey-to-a-better-partner-and-customer-experience"></a><a name="16"></a>Dostawca rozwiązań w chmurze (CSP) i zmiany programu licencjonowania open license: podróż do lepszego partnera i doświadczenia klienta
...
Wszyscy partnerzy w programach CSP i Open
...
Program Microsoft CSP rośnie wykładniczo, a udział w nim bierze ponad 90 000 firm. Jest to nasz główny ruch sprzedażowy partnera dla małych i średnich firm oraz dla mniejszych klientów korporacyjnych w ramach nowego doświadczenia handlowego. W oparciu o ten rozwój ogłosiliśmy dzisiaj, że rozszerzamy możliwości dla partnerów w programie CSP. Szczegółowe informacje znajdują się we [wpisie w blogu partnera](https://blogs.partner.microsoft.com/mpn/expanding-opportunities-for-partners-in-the-cloud-solution-provider-program/).

### <a name="next-steps"></a>Następne kroki

- Przejrzyj wpis [w blogu partnera](https://blogs.partner.microsoft.com/mpn/expanding-opportunities-for-partners-in-the-cloud-solution-provider-program/) i udostępnij informacje odpowiednim osobom w organizacji.

- Zapoznaj się z materiałami na temat gotowości w tematach Ewolucja programu CSP kolekcji zasobów Gotowość do operacji [i Zmiany programu licencjonowania Open License.](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/) Znajdziesz tu prezentację z omówieniem, wskazówki dotyczące licencjonowania, szczegółowe często zadawane pytania dla partnerów i wiele innych przydatnych zasobów. Użyj tej [mapy gotowości,](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf) aby szybko znaleźć odpowiednie informacje dla swojej roli.

### <a name="questions"></a>Masz pytania?

W przypadku pytań związanych z tym powiadomieniem skontaktuj się z [Partner Center pomocy technicznej.](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals)
...
________________
## <a name="availability-of-new-subscriptions-transition-tool-between-partners-for-azure-plan"></a><a name="15"></a>Dostępność nowego narzędzia do przechodzenia subskrypcji między partnerami dla planu platformy Azure 
...
- Odsprzedawcy mogą współpracować ze swoim dostawcą pośrednim. Więcej informacji dla dostawców jest dostępnych w zasobach na stronie New subscriptions transition tool between partners for Azure plan (Nowe narzędzie do przechodzenia [subskrypcji między partnerami dla planu platformy Azure).](https://partner.microsoft.com/resources/collection/transition-tool-azure-subscriptions-new-commerce-experience-csp#/) 

### <a name="summary"></a>Podsumowanie

Od 30 września 2020 r. jest to nowe narzędzie przejściowe do automatyzowania przenoszenia subskrypcji platformy Azure klienta między partnerami biorącymi udział w programie CSP na potrzeby nowego doświadczenia handlowego dla platformy Azure (plan platformy Azure).

Rozszerzenie nowego środowiska handlowego dla platformy Azure zwiększa elastyczność zarządzania subskrypcjami platformy Azure i obsługi rozwijających się potrzeb biznesowych klientów z następującymi korzyściami:  
- Oszczędzaj czas dzięki łatwym w użyciu narzędziom, które automatyzują przejścia platformy Azure  
- Brak zakłóceń w działaniu usług platformy Azure podczas przechodzenia własności rozliczeń 
...
-   To środowisko narzędzi na Partner Center będzie dostępne dla partnerów rozliczanych bezpośrednio i dostawców pośrednich. Odsprzedawcy muszą współpracować z dostawcami pośrednimi, aby korzystać z tego narzędzia w ich imieniu. 
...
-   Trenuj swój zespół i zacznij korzystać z nowego narzędzia przejściowego. 
...
Firma Microsoft działa w oparciu o zaufanie. Dokładamy wszelkich starań, aby zapewnić zgodną, bezpieczną i bezpieczną metodę weryfikacji klienta na potrzeby transakcji ofert academic w programie CSP. W ramach tego zobowiązania w drugim kwartale roku obrachunkowego 2021 (2. kwartał roku obrachunkowego 2021) wprowadzimy ulepszenia interfejsu API i interfejsu użytkownika usługi Partner Center, które dodaą przejrzystość i wgląd w proces weryfikacji klienta. Zapewniają one również możliwość wprowadzania dokładniejszych danych, co poprawi powodzenie weryfikacji klienta.  

### <a name="partner-center-enhancements"></a>Partner Center ulepszenia 

- Nowe interfejsy API kwalifikacji GET i POST będą obsługiwać dokładne wprowadzanie danych i usprawniają proces weryfikacji klientów w edukacji firmy Microsoft. 

- Ulepszenia interfejsu użytkownika będą również obsługiwać dokładne wprowadzanie danych i usprawniają proces weryfikacji klientów edukacyjnych firmy Microsoft. 

### <a name="testing"></a>Testowanie 

Partnerzy będą mieli możliwość przetestowania tych ulepszeń od października 2020 r. Zdecydowanie zachęcamy do tego, aby skorzystać z tej możliwości, aby lepiej zrozumieć interfejsy API i wprowadzanie danych wymagane do pomyślnej weryfikacji klienta. Wkrótce podamy więcej szczegółowych informacji na temat dokładnego czasu i sposobu uczestnictwa. Istniejące interfejsy API Partner Center zostaną wycofane przed końcem 2. kwartału roku 2019. W tym czasie musisz przejść do korzystania z nowych interfejsów API Partner Center api.

### <a name="testing-update"></a>Aktualizacja testowania 

Daty testów partnerów to od 2 października 2020 r. do 2 grudnia 2020 r. Partnerzy, którzy chcą uczestniczyć, powinni przejrzeć [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) (Podręcznik testowania klientów w edukacji) dotyczący tego, jak przygotować się do rejestracji, jak się zarejestrować i czego oczekiwać w fazie testowania.

### <a name="library-and-museum-customers"></a>Klienci biblioteki i biblioteki 

Oprócz opisanych wcześniej ulepszeń z przyjemnością ogłaszamy, że w 2. kwartale roku akademickiego włączymy oferty o cenie akademickiej dla klientów korzystających z biblioteki i edukacji, rozszerzając oferty dla instytucji edukacyjnych, za pomocą których można korzystać z ofert CSP. 
...
Jeśli masz pytania dotyczące tego powiadomienia, skontaktuj się z działem [pomocy Partner Center technicznej.](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals)

## <a name="update---csp-o365-usage-apis-and-csp-license-usage-reports"></a><a name="13"></a>Aktualizacja — interfejsy API użycia usługi O365 dla programu CSP i raporty użycia licencji CSP 
...
Zostaną wprowadzone aktualizacje definicji metryk ujmowane w interfejsach API użycia usług O365 dla programu CSP, aby pomóc partnerom w mierzeniu użycia W365. 
...
Dzięki tej zmianie zostaną zaktualizowane definicje metryk dostępnych za pośrednictwem następujących interfejsów API użycia licencji CSP: 
...
Zaktualizowane definicje są wymienione poniżej. Ponieważ schemat interfejsu API nie zawiera żadnych zmian, nowa integracja nie będzie wymagana. 
...
Rosyjski licencjonowanie zbiorowe (VL), microsoft Business Solutions (MBS) i partnerzy Dostawca rozwiązań w chmurze (CSP)

### <a name="summary"></a>Podsumowanie 

Zmiany dotyczące podatku VAT wprowadzone przez prawo federalne w #265-FZ zostaną zaimplementowane od 1 stycznia 2021 r.

### <a name="details"></a>Szczegóły

Rosyjski prawo federalne #265-FZ z 31 lipca 2020 r. zmodyfikował podsekw.26 sec.2 z art.149 rosyjskich kodów podatkowych. Zgodnie ze zmianami z dniem 01 stycznia 2021 r. w Rosji,  przyznanie wyłącznych praw IP  do oprogramowania i elektronicznych baz danych, które nie zostały uwzględnione w ujednoliconym rejestrze rosyjskich baz danych oprogramowania i elektronicznych baz danych, a także przyznanie praw do użytkowania takiego oprogramowania i baz danych (w tym aktualizacji i uaktualnień), a także udzielenie im dostępu zdalnego za pośrednictwem Internetu,  **nie będzie już zwolniona z podatku VAT.** 

**Należy pamiętać, że po powyższych zmianach podatku VAT w stawce określonej przez obowiązujące prawo zostanie dodany przez MIOL do wszystkich nieistnienie trwałych produktów firmy Microsoft w Rosyjskim.**
...
Partner Center Szczegółowe informacje wkrótce zastąpi wycofane narzędzie do raportowania **MyInsights.** Partner Center Szczegółowe informacje oferuje bogatsze wizualizacje, bardziej szczegółowe możliwości raportowania i kluczowe wskaźniki wydajności obejmujące klientów, subskrypcje, użycie licencji, wydajność odsprzedawcy, szkolenia, kompetencje i korzyści. Skorzystaj z tych inteligentnych szczegółowych informacji, aby jasno zrozumieć swoją firmę z firmą Microsoft i bez obaw podejmować decyzje oparte na danych. Aby rozpocząć, wybierz **Szczegółowe informacje** z Partner Center menu nawigacji po lewej stronie.

**MyInsights** nie będzie już dostępna po 30 września 2020 r. 

### <a name="what-is-insights"></a>Co to jest Szczegółowe informacje?

Pulpit nawigacyjny Szczegółowe informacje w usłudze Partner Center zapewnia ujednolicony, 360-stopniowy widok kluczowych wskaźników wydajności (KPI) organizacji partnerskiej w produktach w chmurze, takich jak Office 365, Azure, Dynamics 365, oraz modeli licencjonowania, takich jak Dostawca rozwiązań w chmurze (CSP) i Enterprise Agreement (EA). Nowe funkcje są stale dodawane, [](../insights-download-reports.md)a wszystkie raporty obsługują eksportowanie danych pierwotnych, co umożliwia przeprowadzanie analizy danych ad hoc w zależności od potrzeb biznesowych. Dwie Partner Center raportowania, Executive Report Viewer i [Report Viewer,](../insights-roles.md)umożliwiają lepsze zarządzanie dostępem i użyciem Szczegółowe informacje w organizacji.

Ostatnio dodane raporty:

- [Raport wydajności odsprzedawcy i eksport danych:](../insights-resellers-performance.md) zawiera omówienie dla dostawców pośrednich dostawców CSP wydajności różnych odsprzedawców pośrednich.

- [Raport możliwości klienta i eksport danych:](../insights-customer-opportunities.md)zawiera omówienie możliwości klientów w zakresie zakupu produktów firmy Microsoft.

Zobacz [Partner Center Szczegółowe informacje — pulpit](../partner-center-insights.md) nawigacyjny, który pokazuje, jak partner komercyjny firmy Microsoft robi, aby uzyskać pełną listę raportów dostępnych w Szczegółowe informacje.

### <a name="next-steps"></a>Następne kroki:

- Często [sprawdzaj Partner Center Szczegółowe informacje,](../partner-center-insights.md) aby dowiedzieć się więcej o aktualizacjach raportowania i ulepszeniach.

- Zachęcamy do eksplorowania tych nowych możliwości i udostępniania opinii przy użyciu narzędzi do wymiany opinii dostępnych w Szczegółowe informacje danych.

________________

## <a name="sdk-release-on-net-standard-v1162"></a><a name="11"></a>Wersja zestawu SDK w .NET Standard (wersja 1.16.2)
...
Od 22 września 2020 r. partnerzy mogą rozpocząć pobieranie wersji zestawu SDK usługi .NET Standard Microsoft Partner Center .NET SDK w wersji 1.16.2 wraz ze zaktualizowanymi publicznymi zestaw SDK Centrum partnerskiego GitHub **przykładami.**

### <a name="details"></a>Szczegóły

Szczegóły [zestawu Microsoft Partner Center .NET SDK](https://www.nuget.org/packages/Microsoft.Store.PartnerCenter/1.16.2) w wersji 1.16.2 są teraz ogólnie dostępne. Zaktualizowane [GitHub przykłady](https://github.com/Microsoft/Partner-Center-DotNet-Samples) są również dostępne. W tej wersji uwzględniono następujące zmiany:
...
Dziś ogłaszamy dostępność usługi Azure SQL Edge, aparatu danych w czasie rzeczywistym zoptymalizowanego pod kątem obciążeń IoT. To rozwiązanie konteneryzowane, bazujące na tym samym aucie, co usługi SQL Server i Azure SQL, zapewnia te same wiodące w branży zabezpieczenia, znane środowisko dewelopera i narzędzia, które już znają i ufają wielu zespołom.
...
Usługa Azure SQL Edge ma uproszczony cennik odpowiedni dla wdrożeń IoT, dostępny nawet za 60 USD rocznie za urządzenie w ramach zobowiązania 3-letniego lub 10 USD miesięcznie za subskrypcję urządzenia.
...
## <a name="upcoming-changes-to-csp-o365-usage-apis-and-csp-license-usage-reports-on-september-30-2020"></a><a name="8"></a>Nadchodzące zmiany w interfejsach API użycia usług O365 i raportach użycia licencji CSP w dniu 30 września 2020 r.
...
Wprowadzimy również nowy interfejs API, który zapewni jednostkę MAU (aktywnych użytkowników miesięcznie) na obciążenie dla każdego z klientów, których zarządzasz.

Ponadto będziemy aktualizować sekcję Podział użycia klientów w raporcie analizy użycia licencji [CSP.](https://partner.microsoft.com/dashboard/analytics/usageanalytics) Od 30 września 2020 r. raport zostanie rozszerzony w celu odzwierciedlenia aktywnych użycia miesięcznego dla Exchange, SharePoint i Skype/Teams.
...
#### <a name="mpa-implementation-update"></a>Aktualizacja implementacji mpA
...
- Skontaktuj się ze odsprzedawcami pośrednimi, którzy nie [](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/) zaakceptowali umowy MPA, i podaj im wskazówki krok po kroku na podstawie etapu, na którym znajdują się w Dostawca rozwiązań w chmurze rejestracji programu.
...
Zmiany w istniejącym interfejsie API, które umożliwiają dostawcom pośrednim zweryfikowanie stanu akceptacji MPA swoich odsprzedawców pośrednich, zostaną zaplanowane na listopad. Partnerzy mogą do listopada złożyć wniosek o dostęp do zaktualizowanego interfejsu API, korzystając z poniższych akcji. Partnerzy korzystający z tego interfejsu API powinni współpracować ze swoim zespołem IT w celu przetestowania i zaimplementowania aktualizacji. 
...
#### <a name="mpa-reporting-in-partner-center"></a>Raportowanie MPA w Partner Center

1. Uzyskaj dostęp do raportu MPA, aby wyświetlić szczegóły odsprzedawców pośrednich z kontem w Partner Center i ich stan akceptacji dla programu MPA. Aby wyświetlić raport, zaloguj się do witryny Partner Center i przejdź do pozycji **Analizuj/Reseller Analytics** w menu po lewej stronie.
...
## <a name="new-skus-bring-the-power-of-project-cortex-and-more-to-customers"></a><a name="5"></a>Nowe jednostki SKU to możliwości Projekt Cortex więcej dla klientów
...
Nowe jednostki SKU, które ułatwiają klientom wykorzystanie możliwości usług [Projekt Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) i [Project Turing,](https://msturing.org/) będą dostępne do transakcji od 1 października 2020 r.

### <a name="details"></a>Szczegóły

Z przyjemnością ogłaszamy 1 października 2020 r. dostępność nowych jednostki SKU, w tym [usług Projekt Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (Intelligent Content Services) i Microsoft Search (w tym łączników microsoft Graph do wyszukiwania), które umożliwią użytkownikom wydajniejsze znajdowanie informacji i zarządzanie nimi.  

#### <a name="intelligent-content-services"></a>Inteligentne usługi zawartości
  
Usługi Intelligent Content Services wykorzystują zaawansowaną AI do automatyzowania przechwytywania, tagowania i zarządzania zawartością. Opiera się on na SharePoint przetwarzania zawartości o dużej ilości danych, wyodrębniania metadanych w celu automatyzacji procesów oraz precyzyjnego zabezpieczenia i zgodność. Inteligentne usługi zawartości ulepszają środowisko obsługi wiedzy i odnajdywania, wypychając bardziej dokładną zawartość do sieci wiedzy. Nowe jednostki SKU inteligentnych usług content services będą dostępne w cenniku **z 1 października** (i w wersji zapoznawczej cennika z 1 września). 
...
- Każdy użytkownik z pakietem lub licencją autonomiczną, która zawiera plan usługi SharePoint lub OneDrive, będzie mógł zobaczyć wyniki wyszukiwania łączników usługi Microsoft Graph dla Microsoft Search. 
...
Dodano ulepszenia zachęt dla partnerów w celu ulepszenia ogólnego środowiska pomocy technicznej dzięki lepszej możliwości odnajdywania zawartości samodzielnej pomocy oraz usprawnionemu procesowi przesyłania biletów, który zmniejsza ilość gromadzenia danych w ramach procesów pomocy technicznej.
...
- Zainicjuj nowe żądanie obsługi bezpośrednio w Partner Center. Po wyświetleniu dostępnej pomocy dotyczącej tematu, jeśli nadal potrzebujesz pomocy, możesz utworzyć bilet tylko bezpośrednio z Partner Center.
- Nowe pytania dotyczące zakresu problemów są dostępne dla każdego tematu samodzielnej pomocy. Wykonanie tych pytań zmniejsza ilość informacji ważnych na początku biletu pomocy technicznej, dostarczając agentowi z góry wiele ważnych informacji.
...
## <a name="upcoming-new-microsoft-dynamics-365-offers"></a><a name="3"></a>Nadchodzące nowe oferty usługi Microsoft Dynamics 365
...
Nadchodzące oferty dla klientów usługi Microsoft Dynamics 365 obejmują wydanie usługi Microsoft Project Operations i dodatkowe środowiska dla usługi Business Central.
...
1 października 2020 r. firma Microsoft wyda oferty dynamics 365 Project Operations i usunie usługę Dynamics 365 Project Service Automation (PSA) dla programu Dostawca rozwiązań w chmurze (CSP). Nowi klienci muszą zakupić usługę Dynamics 365 Project Operations. 
...
- Licencje usługi Dynamics 365 PSA do 31 grudnia 2020 r. będą automatycznie otrzymywać licencje Project Operations w ramach bieżących licencji.
...
Firma Microsoft z przyjemnością ogłasza, że plan połączeń będzie dostępny na następujących nowych rynkach 1 października 2020 r.: W Tym roku: W Tym roku, Francja, Portugalia, Francja i Francja. 

### <a name="details"></a>Szczegóły

Microsoft 365 Plan połączeń będzie dostępny na następujących nowych rynkach od 1 października 2020 r.: W Niemczech, Niemczech, Portugalia, Niemczech i Niemczech. Nowa dostępność geograficzna będzie uruchamiana w komercyjnym, publicznym sektorze na całym świecie, nonprofit i Government Community Cloud za pośrednictwem usług Enterprise Agreement (EA) lub Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct i CSP. 
...
Dodatkowe szczegóły dotyczące planów połączeń, nadmiernego użycia i środków na komunikację można znaleźć w sekcji Calling Plan (Plan połączeń) artykułu [Modern Work Licensing FAQ (Nowoczesne licencjonowanie pracy](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements)— często zadawane pytania).

Plan połączeń jest obecnie dostępny w Japonii, Kanadzie, Francji, Niemczech, Azji, Holandiach, Portoryko (dostępność kanałów ograniczona tylko do ea i EES), Hiszpania, Zjednoczone Królestwo i Stany Zjednoczone (dostępność planu połączeń innych firm w Australii i Japonii).
...
## <a name="microsoft-defender-advanced-threat-protection-atp-for-servers-for-education-is-now-available"></a><a name="1"></a>Zaawansowana ochrona przed zagrożeniami w usłudze Microsoft Defender (ATP) for Servers for Education jest teraz dostępna
...
Zaawansowana ochrona przed zagrożeniami w usłudze Microsoft Defender (ATP) for Servers for Education jest teraz dostępna od 1 września 2020 r. w programie Dostawca rozwiązań w chmurze (CSP).  
Szczegóły oferty produktu:

- Nazwa oferty: Microsoft Defender ATP for Servers for Education
