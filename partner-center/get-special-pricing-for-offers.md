...
1. Na pulpicie Partner Center [nawigacyjnym](https://partner.microsoft.com/dashboard)wybierz ikonę koła zębatego w prawym górnym rogu okna, aby otworzyć **okno Ustawienia konta.**
...
- Oferty edukacyjne można kupić tylko wtedy, gdy Klient ma autoryzację instytucji edukacyjnej. Klient edukacyjny może otrzymać tylko oferty edukacyjne i komercyjne, ale nie chmurę społeczności dla instytucji niedochodowych ani chmurę społeczności dla instytucji rządowych (GCC).
