...
ms.topic: how-to
ms.date: 01/28/2021
description: Dowiedz się, jak opłacić opłatę lub zaktualizować szczegóły płatności związane z uzyskaniem lub odnowieniem co najmniej jednej kompetencji w wersji Silver lub Gold.
...
W tym artykule opisano sposób i czas płacenia opłaty związanej z uzyskaniem silver lub gold Microsoft Partner Network kompetencji. W tym artykule opisano również, jak zmienić preferowaną metodę płatności, jak anulować zamówienie i jak uzyskać rabat w wysokości 25 procent opłaty podczas przechodzenia z kompetencji Silver na Gold.
...
Jeśli zostały już spełnione wymagania dotyczące uzyskania określonej kompetencji Silver lub Gold (lub masz już kompetencję w zakresie silver lub gold), możesz szybko sprawdzić opłatę za kompetencję. Po prostu wybierz [kartę compare-offers](https://partner.microsoft.com/membership/compare-offers) w Partner Center.
...
- Wymagania dotyczące uzyskania [konkretnej kompetencji](https://partner.microsoft.com/membership/competencies) silver lub gold zostały już spełnione.
...
4. Wybierz opcję **Subskrybuj** znajdującą się w prawym dolnym rogu kafelka członkostwa Silver lub Gold.
   ...
   :::image type="content" source="images/offers/1-mpn-competency-payment-offers-available-for-purchase.png" alt-text="Strona ofert członkostwa przedstawiająca członkostwa w grupie Silver lub Gold, które partner może subskrybować lub zakupić." border="false":::

   > [!Note]
   > Jeśli nie zostały jeszcze spełnione wymagania dotyczące wymaganej kompetencji Silver lub Gold, nie będziesz mieć możliwości zasubskrybowania członkostwa w grupie Silver/Gold ani płacenia skojarzonej opłaty za kompetencję. Ponadto, jeśli jesteś już partnerem kompetencji Gold, przyrostowe korzyści z kompetencji Silver zostaną automatycznie przyznane. W tym scenariuszu opcja płacenia opłaty za kompetencję Silver również będzie niedostępna.

4. Na stronie **Szczegóły zakupu** przejrzyj i potwierdź swoje szczegóły.

   (Dowiedz się więcej o aktualizowaniu informacji o identyfikatorze [ **podatkowym**](./organization-tax-info.md) firmy lub adresie [ **faktury/sprzedaży**](./mpn-get-action-pack.md)firmy).

   :::image type="content" source="images/offers/2-mpn-competency-payment-preference.png" alt-text="Strona szczegóły zakupu ofert członkostwa z preferencjami płatności." border="false":::

5. W lewym dolnym rogu strony znajdź sekcję **Wybierz preferencje** dotyczące płatności. Wybierz opcję **Karta kredytowa** lub **Elektroniczne przelew** bankowe, a następnie wybierz pozycję **Dalej.** Dalsze kroki związane z jedną z tych opcji można znaleźć w poniższych sekcjach.

### <a name="use-a-credit-card-as-your-payment-preference"></a>Używanie karty kredytowej jako preferencji płatności

Wykonaj następujące kroki, aby zakończyć płatność kartą kredytową za skojarzoną kompetencję Silver lub Gold.

1. Jeśli jako **preferowaną formę** płatności wybrano kartę kredytową, zostanie wyświetlona strona Szczegóły karty kredytowej. 

   :::image type="content" source="images/offers/3-mpn-competency-payment-credit-card-details.png" alt-text="Strona szczegółów karty kredytowej dla członkostwa oferuje płatności." border="false":::

2. Wybierz link **umowy** w górnej części tej strony i przejrzyj warunki i postanowienia dotyczące zakupu oferty MPN w imieniu swojej firmy. Ta umowa zawiera ważne informacje dotyczące konta rozliczeniowego, odnawiania, uprawnień do zwrotu kosztów i podatków.
...
1. W **obszarze Wybrany obszar** zakupu zanotuj kwotę należną firmie Microsoft i konkretną opłatę w walucie. Musisz przenieść te kwoty z konta bankowego w tej konkretnej walucie.

1. Jeśli masz wszystkie potrzebne informacje, wybierz pozycję **Prześlij.**

   > [!NOTE]
   > Numer **zamówienia i** identyfikator **MPN** pojawią się zaraz po pomyślnym **przesłaniu** zamówienia. Zanotuj te informacje. Będzie on potrzebny później do ukończenia przelewu bankowego.
...
1. Na stronie szczegółów znajdź pole **Potwierdzenie** płatności. Wybierz **pozycję Przeglądaj,** aby zlokalizować i przekazać dokument potwierdzający do Partner Center.
   ...
   :::image type="content" source="images/offers/7-mpn-competency-payment-upload-proof.png" alt-text="Strona szczegółów z polami do przekazywania potwierdzenia, że dla każdej zakupionej oferty jest pokazywana możliwość wyboru, oraz potwierdzenie płatności." border="false":::
...
1. Wypełnij informacje dotyczące innych pól związanych z ostatnią transakcją przelewu środków elektronicznych, takich jak Data **płatności,** Numer konta płatnego i **Transakcja/Ref nr**.
  ...
  Może zostać wyświetlony zielony komunikat informujący o pomyślnym zakończeniu żądania.
...
Jeśli proces płatności nie zostanie całkowicie ukończony w ciągu 30 dni od daty utworzenia zamówienia, stan zamówienia zmieni się na **Wygasłe.** Jeśli Twoje zamówienie wygasło, musisz utworzyć nowe zamówienie bezpośrednio z Partner Center bez konieczności wysyłania płatności jeszcze raz. 
...
Aby zmienić preferencje dotyczące płatności dla istniejącego zamówienia, najpierw musisz anulować zamówienie, a następnie ponownie go nakupić przy użyciu preferowanej formy płatności.

Wykonaj następujące czynności, aby anulować istniejący, nieaktywne przelewy elektroniczne i zmienić preferencje dotyczące płatności:

1. Zaloguj się do [pulpitu nawigacyjnego](https://partner.microsoft.com/dashboard) Centrum partnerskiego.

2. Wybierz **pozycję Oferty członkostwa** z menu nawigacji po lewej stronie.

3. Na liście Zakupione oferty znajdź określoną ofertę, którą chcesz anulować. Następnie w kolumnie Akcja dla tej oferty wybierz pozycję **Anuluj zamówienie**.
...
4. Wykonaj pozostałe kroki, aby anulować zamówienie. 

5. Zapoznaj się z wcześniejszymi sekcjami, aby utworzyć nowe zamówienie z nowymi preferencjami płatności w oparciu o jedną z ofert członkostwa w wersji Silver lub Gold, która jest nadal dostępna dla Ciebie.
...
Jeśli Twoja organizacja ma aktywną kompetencję Silver i spełnia wymagania kwalifikacyjne dotyczące skojarzonej kompetencji Gold, masz prawo do uaktualnienia ze silver do gold w celu uzyskania rabatu. Otrzymasz 25% rabatu na cenę kompetencji Gold.
...
3. W obszarze Oferty dostępne do zakupu poszukaj kafelka członkostwa Gold. Jeśli wcześniej osiągnięto i zapłacono za członkostwo w programie Silver, kwota członkostwa Gold zostanie dostosowana w celu odzwierciedlenia rabatu w wysokości 25 procent.

   :::image type="content" source="images/offers/9-mpn-competency-silver-to-gold-discount.png" alt-text="Zakupione oferty członkostwa pokazują ofertę złotych kafelków z rabatem od silver do gold 25 procent." border="false":::

4. Wybierz **pozycję Subskrybuj** w obrębie kafelka członkostwa Gold, który odzwierciedla rabat. Na stronie szczegółów zakupu będzie również pokazywany rabat dla wybranego zakupu.
