...
### <a name="teams-monthly-usage-report"></a>**Miesięczny raport użycia zespołów**
...
| Month (Miesiąc) | Miesiąc, dla którego jest zgłaszane użycie | 
| Podsieć | Podsieć, dla której jest zgłaszane użycie (spotkania, połączenia lub systemy telefoniczne) | 
| Użytkownicy pulpitu | Liczba użytkowników korzystających z aplikacji Teams na komputerze | 
...
### <a name="teams-usage-3p-apps-report"></a>**Raport aplikacji 3P użycia usługi Teams**
...
| Zmniejszenie kosztów i zarządzania — Microsoft 365 E3 dla Microsoft 365 E5 | Istniejący klient z Microsoft 365 E3, docelowy Microsoft 365 E5 | 
| Zmniejszenie kosztów i zarządzania — Microsoft 365 Business Basic i Business Standard, których celem jest Microsoft 365 Business Premium | Istniejący Microsoft 365 Business Basic i Business Standard, docelowa dla Microsoft 365 Business Premium | 
...
| M365Cluster | Określa, czy klient jest podatny na zakup Microsoft 365. Ustaw jako cel ustaw teraz i oceń klastry, ponieważ wyniosą one wyższą rentowność. Należy kierować działania do klientów i edukować ich tylko wtedy, gdy nadal dostępna jest pojemność po ustawieniu teraz i ocenienia klientów. | 
...
| O365Cluster | Określa, czy klient jest podatny na zakup usługi Office 365. Ustaw jako cel teraz i oceń klastry, ponieważ wyniosą one wyższą rentowność. Należy kierować działania do klientów i edukować ich tylko wtedy, gdy nadal istnieje pojemność po ustawieniu się teraz i ocenienia klientów. | 
...
| Zarządzanie ryzykiem finansowym & oszustwem — lokalna baza instalacji usługi Dynamics — inne (model proporcjonalności w centrali biznesowej) | Istniejący klient z innymi rozwiązaniami lokalnymi, które nie zostały wcześniej wymienione. Partner powinien być ukierunkowany na usługę Dynamics 365 Business Central. | 
...
| Licencja systemu Windows Server Standard | Wyświetla typ licencji zakupów systemu Windows Server w standardowych wersjach przez klienta | 
