...
Partnerzy firmy Microsoft w programie Dostawca rozwiązań w chmurze (CSP) mają coraz większy katalog ofert dostępnych dla nich. Możesz sprzedawać pełną gamę usług w chmurze firmy [Microsoft](https://partner.microsoft.com/cloud-solution-provider/products-and-services)oraz różne inne oferty, które często się zmieniają. Aby wyświetlić oferty CSP dla bieżącego miesiąca, zaloguj się do pulpitu nawigacyjnego Partner Center [i](https://partner.microsoft.com/dashboard) wybierz **kafelek Cennik.**  
...
Klienci mogą zarezerwować miejsce na maszynach wirtualnych platformy Azure z wyprzedzeniem na okres 1 roku lub 3 lat.
...
*Usługi online* to nowa nazwa, która jest obecnie nazywana *subskrypcjami*. Aby ułatwić zamawianie wielu typów produktów w jednym miejscu, zintegrowaliśmy przepływ zadań "Dodaj subskrypcję" z przepływem zadań "Dodaj produkty".
...
**Wyświetlanie sku, wyświetlanie produktu** — wybierz opcję przełączania między listami produktów i SKU. Na **stronie Produkty** poszczególne produkty są wymieniane osobno; **SKU wyświetla** listę grup produktów.
