...
- Nowe rezerwacje ofert platformy Azure (plan platformy Azure)
...
- Ostatnie działanie uzgadniania użycia ocenianego codziennie (.csv)
...
## <a name="how-do-i-know-if-im-earning-pec"></a>Jak mogę się, czy zarobkuję PEC?
...
PEC nie jest jawnie wywoływana na fakturze i nie ma oddzielnego wiersza do wyświetlania PEC, jednak zarobki PEC są uwzględniane w skorygowanej kwoty opłat netto na fakturze. Aby dowiedzieć się więcej o tym, gdzie można wyświetlić szczegóły PEC, zobacz sekcje How is PEC paid (Jak są płatne PEC).
