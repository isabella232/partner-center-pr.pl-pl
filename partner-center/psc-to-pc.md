...
description: Dowiedz się, jak partnerzy firmy Microsoft mogą przeprowadzać migrację z witryny Partner Sales Połączenie (PSC) do usługi Partner Center i tworzyć transakcje wysyłane przez sprzedawców firmy Microsoft oraz zarządzać nimi.
author: vikramb
ms.author: vikramb
...
- Skontaktuj się z administratorem usługi PSC, Partner Center skonfigurowanie konta usługi jest ukończone niezależnie od konta, za pomocą których loguje sięsz do centrum psc.
...
Po skonfigurowaniu konta w programie Partner Center użyj kreatora migracji użytkowników na stronie możliwości współpracy sprzedaży, aby automatycznie przypisać Partner Center ról do pracowników firmy.
...
Po zakończeniu migracji użytkowników użyj kreatora migracji transakcji na stronie możliwości sprzedaży, aby dostawić wszystkie kwalifikujące się otwarte transakcje z witryny PSC do Partner Center. **Link migracji transakcji będzie widoczny tylko dla administratorów poleceń z całym zakresem organizacji w Partner Center.** W prawym górnym rogu strony szans wspólnej sprzedaży będzie dostępny link o nazwie **„Migracja transakcji PSC”** umożliwiający otwarcie kreatora migracji transakcji.
...
Wszystkie transakcje, które zostały pomyślnie zmigrowane, nie będą widoczne w konsoli psc. Możesz kontynuować pracę nad zmigrowanych umowami w Partner Center w tym nad ukończeniem rejestracji transakcji w Partner Center. Nie będzie żadnych zmian w interakcjach ze sprzedawcami firmy Microsoft w przypadku transakcji sprzedaży.
...
Jeśli Twoja firma ma menedżera rozwoju partnerów (PDM) — po skonfigurowaniu konta usługi Partner Center, w którym użytkownicy przeszli i mają role oraz uprawnienia, możesz przenieść działania związane ze sprzedażą do Partner Center. Poinformuj pdm, aby przełączyć się, zamiast czekać na ukończenie terminu migracji, co umożliwi przepływ wszystkich nowych transakcji do Partner Center.
...
- **Co oznacza czerwone kółko?** Jeśli na jednym zrzucie ekranu zostanie wyświetlony czerwony okrąg, oznacza to, że pole PSC nie jest dostępne w Partner Center.
...
1. Widok PSC Add Products (Dodawanie produktów psc) zamapowany na widok Partner Center Dodaj rozwiązania
...
Porównaj pasujące, numerowane okręgi między górnym zrzutem ekranu psc i Partner Center zrzutem ekranu poniżej. Pasujące liczby pokazują, gdzie można znaleźć cechę lub atrybut związany z psc w Partner Center. Czerwone okręgi wskazują, że nie ma pasującego Partner Center pola.  
...
:::image type="content" source="images/pscmigration/dealdetails.png" alt-text="Obraz przedstawiający mapowania pól między widokiem szczegóły transakcji Połączenie Partner Sales Połączenie (PSC) i widokiem szczegółów Partner Center transakcji." lightbox="images/pscmigration/deal-details-expanded.png":::
...
- Użytkownik-gość w programie Partner Center — możesz dodać konto PDM jako użytkownika-gościa w programie Partner Center i przypisać mu rolę administratora poleceń, aby był w stanie wyświetlać polecenia i działać na @microsoft.com nich.
...
- Jeśli nie masz kontrolera PDM, wyślij wiadomość e-mail na adres podany na banerze PSC z informacjami o koncie PSC widocznymi na banerze PSC i prawidłowym identyfikatorem MPN z konta Partner Center.
...
|Rejestrowanie transakcji, które zostały zwyciężyły w Partner Center |[Rejestrowanie nowej transakcji](./register-deals.md)
...
- [Partner Center — wskazówki dotyczące](https://partner.microsoft.com/resources/detail/co-sell-operating-model-guide-pptx) identyfikowania modelu operacyjnego za pośrednictwem usługi Partner Center do zarządzania potencjalnymi klientami lub możliwościami sprzedaży i rejestrowania transakcji.
