...
|Kupowanie rezerwacji platformy Azure w Azure Portal | [Prepay for virtual machines with Azure Reserved VM Instances](/azure/virtual-machines/windows/prepay-reserved-vm-instances) in the Azure Help (Prepay for virtual machines with Azure Reserved VM Instances in the Azure Help (Prepay for virtual machines with Azure Reserved VM Instances in the Azure Help |
