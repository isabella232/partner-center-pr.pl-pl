...
Nie każde pole w szablonie jest edytowalne. Istnieją pola, które są zawsze tylko do odczytu, niektóre z nich zmienią się na stan tylko do odczytu po utworzeniu odwołania, a niektóre zmienią się na tylko do odczytu po zmianie na określoną wartość.
...
### <a name="fields-that-will-become-read-only-after-you-create-the-referral"></a>Pola, które staną się tylko do odczytu po utworzeniu polecenia
...
### <a name="fields-that-will-become-read-only-after-you-first-share-them"></a>Pola, które staną się tylko do odczytu po ich pierwszym udostępnieniu

- **Imię osoby kontaktowej klienta** po przesłaniu szczegółów dotyczących tworzenia lub uaktualniania poleceń do współpracy zostanie zamienine tylko do odczytu
- **Nazwisko osoby kontaktowej klienta** po przesłaniu szczegółów dotyczących tworzenia lub uaktualniania poleceń do współpracy zostanie zamienine tylko do odczytu
- **Numer Telefon klienta** zostanie zamienić tylko do odczytu po przesłaniu szczegółów dotyczących tworzenia lub uaktualniania poleceń do współpracy
- **Adres e-mail kontaktu** z klientem zostanie zamienić tylko do odczytu po przesłaniu szczegółów dotyczących tworzenia lub uaktualniania poleceń do współpracy
- **Wymagana jest pomoc firmy Microsoft?** Po oznaczeniu go jako Tak spowoduje to wyłączenie tylko do odczytu
- **Jaka jest pomoc firmy Microsoft?** Spowoduje to wyłączenie tylko do odczytu po wprowadzeniu liczby w określonym formacie
- **Udostępnianie zespołowi sprzedaży firmy Microsoft** spowoduje wyłączenie go tylko do odczytu po oznaczeniu go jako Tak
- **Uwagi do firmy Microsoft** zostaną zamienić tylko do odczytu po przesłaniu notatek na temat tworzenia lub uaktualniania poleceń do współpracy

Szczegółowe informacje o wszystkich kolumnach wraz ze szczegółami i przykładami znajdują się w poniższej tabeli.
...
Kraj klienta|Tak|Kraj/region, w którym znajduje się organizacja klienta. Użyj dwulitowego *kodu alfa-2 z* tej [listy kodów krajów.](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes)|USA
