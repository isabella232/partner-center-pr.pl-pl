...
Nazwa transakcji|Yes|Przyjazna nazwa transakcji dla Twojej odwołania.|Uk spring deal
Nazwa klienta|Yes|Nazwa firmy klienta. Użyj prawnej nazwy organizacji, aby szybko dopasować po stronie firmy Microsoft.|Contoso Corporation
Wiersz 1 adresu klienta|Yes|Wiersz 1 adresu firmy klienta. |One Contoso Way
Wiersz 2 adresu klienta|Nie|Adres 2 firmy klienta.|NE 148, ulica
Customer City|Yes|Miasto, w którym znajduje się organizacja klienta.|Redmond
...
Kraj klienta|Yes|Kraj/region, w którym znajduje się organizacja klienta. Użyj dwulitowego *kodu alfa-2 z* tej [listy kodów krajów.](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes)|USA
Identyfikator D-U-S klienta|Nie|Spróbuj pobrać identyfikator DUNS organizacji klienta. Pomoże to w szybszym dopasowaniu organizacji klienta po stronie firmy Microsoft, co ułatwia szybsze przypisywanie sprzedawców. Identyfikator DUNS ID FREE można uzyskać na stronie wyszukiwania liczb [D-U-N-S](https://www.dnb.com/duns-number/lookup.html).|81466849
...
Szacowana wartość transakcji|Yes|Wartość transakcji na podstawie początkowych konwersacji z klientem. Można ją zmienić, dopóki transakcja nie osiągnie jednego z stanów końcowych, które **zostały wygrane** lub **utracone.**|12563
Waluta|Yes|Waluta, w której wprowadzana jest wartość transakcji. Kody walut można znaleźć na [stronie Wikipedii ISO 4217.](https://en.wikipedia.org/wiki/ISO_4217)|USD
Szacowana data zamknięcia|Yes|Szacowana data zamknięcia transakcji na podstawie początkowych konwersacji z klientem w formacie MM/DD/YYYY. <br/> **Data powinna być w strefie czasowej UTC. Wszystkie daty wyświetlane w interfejsie Partner Center są oparte na zlokalizowanych strefach czasowych. Jeśli patrzysz na polecenie, dla którego podano datę w strefie czasowej UTC, Partner Center interfejsie użytkownika może wystąpić +/- jeden dzień różnicy.**|1/30/2020
...
Wymagana jest pomoc firmy Microsoft?|Yes|Ma to na celu wskazanie, czy chcesz, aby firma Microsoft pomogła Ci w zrzucie wniosku o współs sprzedaży|Yes
...
Udostępnianie zespołowi sprzedaży firmy Microsoft|Yes|Ma to na celu wskazanie, czy chcesz udostępnić szczegóły transakcji zespołowi sprzedaży firmy Microsoft, czy nie. Ma to zastosowanie tylko w przypadku wybrania opcji Nie dla pytania "Wymagana pomoc firmy Microsoft? "|Yes
...
Zgoda na udostępnianie kontaktu klienta/partnera|Yes|Zgoda na udostępnianie danych kontaktowych klienta i danych kontaktowych pracowników firmy pracujących nad ofertą. **Transakcje nie będą tworzone ani aktualizowane, jeśli dla tej kolumny wybierzesz pozycję Nie.** |Yes
...
Rozwiązanie 1|Yes|Identyfikator rozwiązania (wymagane), waluta (opcjonalnie), w której wprowadzono wartość transakcji. Możesz znaleźć kody [walut,](https://en.wikipedia.org/wiki/ISO_4217)cenę sku (opcjonalnie) i ilość (opcjonalnie)  |SOL-1234-PQRS, USD, 10, 100
Członek zespołu 1|Yes|Imię, nazwisko, numer telefonu komórkowego i identyfikator e-mail odpowiedniego członka zespołu.| Bob, Partner, 999999, Bob.partner@Contoso.com
