...
- **Udostępnianie zespołowi sprzedaży firmy Microsoft** spowoduje włączenie tylko do odczytu po oznaczeniu go jako Tak
- **Uwagi do firmy Microsoft** będą włączane tylko do odczytu po przesłaniu notatek na temat tworzenia lub uaktualniania poleceń do współs sprzedaży
