...
- Nie musisz czekać na ukończenie akcji pobierania. Nawet jeśli przechodzisz do innych stron w Partner Center, plik zostanie pobrany zaraz po zakończeniu działania funkcji eksportowania.
...
> [!IMPORTANT]
> Przeczytaj dokładnie wszystkie instrukcje i sprawdź format poszczególnych kolumn z poniższej tabeli przed utworzeniem lub zaktualizowaną transakcjami przy użyciu plików CSV w Partner Center.
...
Szacowana data zamknięcia|Tak|Szacowana data zamknięcia transakcji na podstawie początkowych konwersacji z klientem w formacie MM/DD/YYYY. <br/> **Data powinna być w strefie czasowej UTC. Wszystkie daty wyświetlane w interfejsie Partner Center są oparte na zlokalizowanych strefach czasowych. Jeśli patrzysz na polecenie, dla którego podano datę w strefie czasowej UTC, Partner Center interfejsie użytkownika może być +/- jedną różnicą.**|1/30/2020
