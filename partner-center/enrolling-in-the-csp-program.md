...
3. Utwórz profil partnera. Możesz sprawdzić profil firmy lub ręcznie wprowadzić informacje o firmie. Jeśli Twoja firma jest zarejestrowana w [firmie Dun & Bradstreet,](https://partner.microsoft.com/marketing/usisvshowcase/dunandbrad)użyj identyfikatora DUNS, aby znaleźć informacje o firmie. Jeśli chcesz podać szczegóły swojej firmy samodzielnie, wybierz pozycję  **Wprowadź ręcznie.**
    ...
    W przypadku niektórych krajów po ręcznym wprowadzeniu adresu zweryfikujemy Twój adres. Jeśli wprowadzany adres różni się od zweryfikowanego, zalecamy użycie zweryfikowanego adresu. Gwarantuje to, że elementy adresu są ustryzowane zgodnie z definicją w urzędzie pocztowym kraju, są poprawnie sformatowane i można je wysyłać.
...
Aby uzyskać więcej informacji o tym, co jest wymagane do uczestnictwa w programie CSP jako odsprzedawca pośredni, zobacz [Wprowadzenie](https://partner.microsoft.com/cloud-solution-provider/whats-required) jako odsprzedawca pośredni w Microsoft Partner Network [internetowej](https://partner.microsoft.com/).
