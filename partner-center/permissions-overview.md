...
||* Może działać w narzędziu do weryfikacji walidowania wali|
...
||    Może wyświetlać i rejestrować transakcje dla szans sprzedaży, które są oznaczone jako wygrane i uprawnione do rejestracji transakcji, jeśli są członkami zespołu.
||    Może tworzyć i wyświetlać bilety pomocy technicznej
