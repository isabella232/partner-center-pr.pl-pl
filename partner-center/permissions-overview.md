...
||* Wyświetlanie szczegółów użytkownika i ich danych umiejętności
||* Wyświetlanie kompetencji
||* Wyświetlanie korzyści i zarządzanie nimi
||* Wyświetlanie i kupowanie ofert MPN
||* Wyświetl historię zamówień i faktury dla oferty MPN
||* Wyświetlanie danych wskaźnika udziału partnera
||* Może działać w narzędziu do walidacji Jedli|
...
|------------------------------|:-------------------------|
|Cała firma | Zarówno administratorzy, jak i użytkownicy mają dostęp do tworzenia transakcji dla dowolnej lokalizacji w firmie|
...
|Co najmniej jedna lokalizacja | Zarówno administratorzy, jak i użytkownicy mają dostęp do tworzenia transakcji dla przypisanej lokalizacji w firmie|
...
|**Role** | **Co możesz zrobić**|**Dowiedz się więcej**|
|------------------------------|:-------------------------|---|
|Przeglądarka raportów dla kierownictwa|Dostęp do wszystkich zestawów danych raportowania, tworzenie biletów pomocy technicznej dla partnerów, wyświetlanie tworzyć biletów pomocy technicznej dla partnerów|[Omówienie raportów pulpitu nawigacyjnego dostępnych w Partner Center Szczegółowe informacje](insights-overview-report.md)
