...
##### <a name="issue-4-partner-cannot-implement-mfa-using-ms-authenticator-app"></a>Problem 4. Partner nie może zaimplementować usługi MFA przy użyciu Authenticator MS
...
Partnerzy mogą wystąpić o wyjątek techniczny, aby pominąć weryfikację MFA, jeśli napotkają problemy techniczne z usługami Online Services firmy Microsoft i nie istnieje żadne możliwe rozwiązanie ani obejście problemu. Zanim to zrobisz, [zapoznaj się z listą typowych problemów](#list-of-common-issues) w poprzedniej sekcji.
