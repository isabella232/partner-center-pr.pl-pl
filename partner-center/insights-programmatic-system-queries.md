...
Aby uzyskać więcej informacji na temat nazw kolumn, atrybutów i opisu, zapoznaj się z [definicjami danych](insights-data-definitions.md)

Poniższe sekcje zawierają zapytania dotyczące raportów dla różnych raportów.

## <a name="customers"></a>Klienci

Raport Klienci z ostatnich sześciu miesięcy
...
## <a name="seats-subscriptions-and-revenue"></a>Subskrypcje stanowisk i przychód

Stanowiska, subskrypcje i raport przychodów z ostatnich sześciu miesięcy
...
Raport AzureUsage z ostatnich sześciu miesięcy
...
## <a name="office-usage"></a>Office Użycia

Raport OfficeUsage z ostatnich sześciu miesięcy
...
## <a name="ems-usage"></a>Użycie usług EMS

Raport EMSUsage przez sześć miesięcy
...
## <a name="cloud-products-reseller-performance"></a>Wydajność odsprzedawcy produktów w chmurze
...
## <a name="clas-azure-propensity"></a>Clas Azure propensity

Raport CLASAzurePropensity przez sześć miesięcy
...
## <a name="teams-usage-3p-apps"></a>Teams Użycie aplikacji 3P

Raport TeamsUsage3PApps przez sześć miesięcy
...
## <a name="teams-usage-workload"></a>Teams obciążenia użycia

Raport TeamsUsageWorkload przez sześć miesięcy
