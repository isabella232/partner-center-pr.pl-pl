...
Mimo że KMS kluczy nie są dostępne w programie CSP, nadal można przenieść licencje lokalne klienta z licencjonowania zbiorowego do CSP i zapobiec przestojom spowodowanym przez przełączenie kanału zakupu. KMS dystrybuuje licencje do klientów i zazwyczaj pozostają aktywne przez 180 dni, zanim urządzenie spróbuje odnowić aktywację. Oznacza to, że urządzenie zostanie już aktywowane i będzie działać przez pewien czas, zanim pojawią się jakiekolwiek problemy. 
