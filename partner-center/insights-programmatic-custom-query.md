...
Ta część zapytania określa czas trwania, dla którego dane muszą być eksportowane. Możliwe wartości powinny pochodzić z pola *availableDateRanges* w definicji zestawu danych.
