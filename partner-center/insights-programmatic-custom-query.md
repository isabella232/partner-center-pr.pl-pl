...
- **WhereClause**: `WHERE FilterCondition (AND FilterCondition)`
    - **FilterCondition:** wartość operatora ColumOrMetricName
        ...
        - **Wartość:** Liczba | StringLiteral | Lista MultiNumberList | MultiStringList
            - **Liczba:**`-? [0-9]+ (. [0-9] [0-9]*)?`
