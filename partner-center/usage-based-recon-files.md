...
| ChargeEndDate | Data końcowa cyklu rozliczeniowego, z wyjątkiem prezentowania dat wcześniej niezapłacanych danych użycia ukrytego (z poprzedniego cyklu rozliczeniowego). Czas to zawsze koniec dnia, 23:59. | *2/28/2019 23:59* |
...
| ServiceName | Nazwa usługi platformy Azure, która jest w tym przypadku problemem. | *MASZYNY WIRTUALNE* |
