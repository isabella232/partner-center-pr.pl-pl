...
Po zastosowaniu środków lub  **korekt zobaczysz** korekty i środki zaległych na następnej fakturze rozliczeniowej.
...
Opłaty są naliczone na podstawie twoich danych (a nie danych klientów), ponieważ relacja rozliczeń jest między firmą Microsoft i Tobem. Identyfikator podatkowy można przesłać później podczas procesu konfiguracji konta lub za pośrednictwem wniosku o pomoc techniczną. Zmiany zostaną odzwierciedlone w następnym cyklu rozliczeniowym.

W **przypadku zwolnienia z podatku potrącenia i** sprzedaży należy przesłać dokumentację dotyczącą podatku za pośrednictwem wniosku o pomoc techniczną. Zobaczysz zmiany i odpowiednie zwroty w następnym cyklu rozliczeniowym. Dowiedz się więcej na temat przesyłania [podatku potrącenia.](withholding-tax-credit-form.md) 

W **przypadku zwolnienia z podatku od wartości dodanej (VAT)** należy przesłać identyfikator VAT (zweryfikowany przez firmę Microsoft) za pośrednictwem żądania obsługi.  Jeśli identyfikator VAT zostanie przesłany po konfiguracji konta (za pośrednictwem wniosku o pomoc techniczną), faktury przed tym żądaniem nie będą mieć sygnatury VAT w pliku PDF faktury. Zmiany zostaną wprowadzone w następnym cyklu rozliczeniowym.
...
Może być konieczne zażądanie środków lub ich przelewu z następujących powodów:
...
- [Historia zamówień klientów](csp-offers.md) 
