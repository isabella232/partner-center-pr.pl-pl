...
4. Jeśli miernik lub jakiekolwiek zasoby emitujące ten  miernik kwalifikowały się do środków uzyskane przez partnera dla usług zarządzanych przez część miesiąca, plik rekonescji będzie zawierać dwa wiersze rozliczeń. Jeden wiersz będzie reprezentować dni, w których miernik został zakwalifikowany, a drugi wiersz będzie reprezentować dni, w których miernik nie kwalifikował się.
...
- Zobacz, jak są obliczane punkty uzyskane przez partnera. Zaloguj się do Partner Center [nawigacyjnego i](https://partner.microsoft.com/dashboard/) znajdź dostępny cennik.
