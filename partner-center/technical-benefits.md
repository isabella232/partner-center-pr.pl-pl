...
description: Dowiedz się więcej Microsoft Partner Network (MPN) dla technicznych usług przedsprzedażowych i wdrożeniowych (TPD)
...
**Odpowiednie role:** dowolne konto użytkownika MPN w organizacji z aktywną kompetencją lub kontem microsoft Action Pack.
...
2. Zostanie wyświetlona strona Korzyści techniczne z listą korzyści pomocy technicznej dostępnych w przypadku ofert członkostwa w programie Gold, Silver Action Pack Microsoft. 
